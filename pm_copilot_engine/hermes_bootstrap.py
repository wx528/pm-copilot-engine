...
# Apply on import — entry points just need ``import pm_copilot_engine.hermes_bootstrap``
# (or ``from pm_copilot_engine.hermes_bootstrap import apply_windows_utf8_bootstrap``) at
