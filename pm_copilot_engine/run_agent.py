...
# `mock.patch("run_agent.<X>")`, `from pm_copilot_engine.run_agent import <X>` in production
# siblings, or the `_ra().<X>` indirection in agent/system_prompt.py — none
# of which ruff's in-module usage scan can see.
from pm_copilot_engine.agent.process_bootstrap import (
    OpenAI,  # noqa: F401  # re-exported for tests that mock.patch("run_agent.OpenAI")
    _SafeWriter,  # noqa: F401  # re-exported for tests that `from pm_copilot_engine.run_agent import _SafeWriter`
    _get_proxy_for_base_url,
)
from pm_copilot_engine.agent.iteration_budget import IterationBudget


from pm_copilot_engine._internal.hermes_cli.env_loader import load_hermes_dotenv
from pm_copilot_engine._internal.hermes_cli.timeouts import (
...
from pm_copilot_engine.model_tools import (
...
from pm_copilot_engine.tools.terminal_tool import cleanup_vm
from pm_copilot_engine.tools.interrupt import set_interrupt as _set_interrupt
from pm_copilot_engine.tools.browser_tool import cleanup_browser


# Agent internals extracted to agent/ package for modularity
from pm_copilot_engine.agent.memory_manager import sanitize_context
from pm_copilot_engine.agent.error_classifier import FailoverReason
from pm_copilot_engine.agent.redact import redact_sensitive_text
from pm_copilot_engine.agent.model_metadata import (
    estimate_request_tokens_rough,  # noqa: F401  # re-exported for tests that mock.patch("run_agent.estimate_request_tokens_rough")
    is_local_endpoint,
)
from pm_copilot_engine.agent.usage_pricing import normalize_usage
# Re-exported for tests that monkeypatch these symbols on run_agent.
from pm_copilot_engine.agent.context_compressor import ContextCompressor  # noqa: F401
from pm_copilot_engine.agent.retry_utils import jittered_backoff  # noqa: F401
from pm_copilot_engine.agent.prompt_builder import (  # noqa: F401  # re-exported via _ra() / mock.patch("run_agent.<name>") / from pm_copilot_engine.run_agent import <name>
...
from pm_copilot_engine.agent.process_bootstrap import _get_proxy_from_env  # noqa: F401
from pm_copilot_engine.agent.message_sanitization import (  # noqa: F401
    _SURROGATE_RE,
...
from pm_copilot_engine.agent.codex_responses_adapter import (
...
from pm_copilot_engine.agent.tool_guardrails import (
    ToolGuardrailDecision,
    append_toolguard_guidance,
    toolguard_synthetic_result,
)
from pm_copilot_engine.agent.tool_result_classification import (
    FILE_MUTATING_TOOL_NAMES as _FILE_MUTATING_TOOLS,
    file_mutation_result_landed,
)
from pm_copilot_engine.agent.trajectory import (
    convert_scratchpad_to_think,
    save_trajectory as _save_trajectory_to_file,
)
from pm_copilot_engine.agent.tool_dispatch_helpers import (
    _should_parallelize_tool_batch,
    _is_destructive_command,  # noqa: F401  # re-exported for tests that access `run_agent._is_destructive_command`
    _extract_parallel_scope_path,  # noqa: F401  # re-exported for tests that `from pm_copilot_engine.run_agent import _extract_parallel_scope_path`
    _paths_overlap,  # noqa: F401  # re-exported for tests that `from pm_copilot_engine.run_agent import _paths_overlap`
    _is_multimodal_tool_result,
    _multimodal_text_summary,
    _append_subdir_hint_to_multimodal,  # noqa: F401  # re-exported for tests that `from pm_copilot_engine.run_agent import _append_subdir_hint_to_multimodal`
    _extract_file_mutation_targets,
    _extract_error_preview,
    _trajectory_normalize_msg,  # noqa: F401  # re-exported for tests that `from pm_copilot_engine.run_agent import _trajectory_normalize_msg`
)
from pm_copilot_engine.utils import atomic_json_write, base_url_host_matches, base_url_hostname, is_truthy_value, model_forces_max_completion_tokens
...
def _routermint_headers() -> dict:
    ...
    from pm_copilot_engine._internal.hermes_cli import __version__ as _HERMES_VERSION
...
class AIAgent:
    ...
    def __init__(
        ...
        from pm_copilot_engine.agent.agent_init import init_agent
        init_agent(
            self,
            base_url=base_url,
            api_key=api_key,
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        if (self.provider or "").strip().lower() != "lmstudio":
            return
        try:
            from pm_copilot_engine.agent.model_metadata import MINIMUM_CONTEXT_LENGTH
            from pm_copilot_engine._internal.hermes_cli.models import ensure_lmstudio_model_loaded
    ...
    def switch_model(self, new_model, new_provider, api_key='', base_url='', api_mode=''):
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import switch_model
    ...
    from pm_copilot_engine.agent.stream_diag import STREAM_DIAG_HEADERS as _STREAM_DIAG_HEADERS  # noqa: E402

    @staticmethod
    def _stream_diag_init() -> Dict[str, Any]:
        """Forwarder — see ``agent.stream_diag.stream_diag_init``."""
        from pm_copilot_engine.agent.stream_diag import stream_diag_init
    ...
    def _stream_diag_capture_response(
        ...
        from pm_copilot_engine.agent.stream_diag import stream_diag_capture_response
    ...
    def _flatten_exception_chain(error: BaseException) -> str:
        ...
        from pm_copilot_engine.agent.stream_diag import flatten_exception_chain
    ...
    def _log_stream_retry(
        ...
        *,
        ...
        from pm_copilot_engine.agent.stream_diag import log_stream_retry
        log_stream_retry(
    ...
    def _emit_stream_drop(
        ...
        *,
        ...
        from pm_copilot_engine.agent.stream_diag import emit_stream_drop
        emit_stream_drop(
    ...
    def _check_compression_model_feasibility(self) -> None:
        ...
        from pm_copilot_engine.agent.conversation_compression import check_compression_model_feasibility
    ...
    def _replay_compression_warning(self) -> None:
        ...
        from pm_copilot_engine.agent.conversation_compression import replay_compression_warning
    ...
    def _compute_non_stream_stale_timeout(self, api_payload: Any) -> float:
        ...
        from pm_copilot_engine.agent.chat_completion_helpers import estimate_request_context_tokens
    ...
    def _anthropic_prompt_cache_policy(
        ...
        *,
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import anthropic_prompt_cache_policy
    ...
    def _provider_model_requires_responses_api(
        ...
        *,
        ...
        if normalized_provider == "copilot":
            try:
                from pm_copilot_engine._internal.hermes_cli.models import _should_use_copilot_responses_api
    ...
    def _strip_think_blocks(self, content: str) -> str:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import strip_think_blocks
    ...
    def _looks_like_codex_intermediate_ack(
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import looks_like_codex_intermediate_ack
    ...
    def _extract_reasoning(self, assistant_message) -> Optional[str]:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import extract_reasoning
    ...
    def _cleanup_task_resources(self, task_id: str) -> None:
        ...
        from pm_copilot_engine.agent.chat_completion_helpers import cleanup_task_resources
        return cleanup_task_resources(self, task_id)

    # ------------------------------------------------------------------
    # Background memory/skill review — prompts live in agent.background_review
    # ------------------------------------------------------------------
    from pm_copilot_engine.agent.background_review import (
    ...
    def _summarize_background_review_actions(
        ...
        from pm_copilot_engine.agent.background_review import summarize_background_review_actions
    ...
    def _spawn_background_review(
        ...
        keep working.
        """
        from pm_copilot_engine.agent.background_review import spawn_background_review_thread
    ...
    def _build_memory_write_metadata(
        ...
        *,
        ...
        from pm_copilot_engine.agent.background_review import build_memory_write_metadata
    ...
    def _repair_message_sequence(self, messages: List[Dict]) -> int:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import repair_message_sequence
    ...
    def _format_tools_for_system_message(self) -> str:
        ...
        from pm_copilot_engine.agent.system_prompt import format_tools_for_system_message
    ...
    def _convert_to_trajectory_format(self, messages: List[Dict[str, Any]], user_query: str, completed: bool) -> List[Dict[str, Any]]:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import convert_to_trajectory_format
    ...
    def _extract_api_error_context(error: Exception) -> Dict[str, Any]:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import extract_api_error_context
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli import plugins as _plugins
    ...
    def _dump_api_request_debug(
        ...
        *,
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import dump_api_request_debug
    ...
    def _file_mutation_verifier_enabled(self) -> bool:
        ...
        try:
            ...
            try:
                from pm_copilot_engine._internal.hermes_cli.config import load_config as _load_config
    ...
    def _apply_pending_steer_to_tool_results(self, messages: list, num_tool_msgs: int) -> None:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import apply_pending_steer_to_tool_results
    ...
    def _touch_activity(self, desc: str) -> None:
        ...
        if os.environ.get("HERMES_KANBAN_TASK"):
            try:
                from pm_copilot_engine.tools.kanban_tools import heartbeat_current_worker_from_env
    ...
    def _capture_rate_limits(self, http_response: Any) -> None:
        ...
        if not headers:
            return
        try:
            from pm_copilot_engine.agent.rate_limit_tracker import parse_rate_limit_headers
    ...
    def _capture_credits(self, http_response: Any) -> None:
        ...
        try:
            from pm_copilot_engine.agent.credits_tracker import dev_fixture_credits_state
        ...
        try:
            from pm_copilot_engine.agent.credits_tracker import parse_credits_headers
    ...
    def _emit_credits_notices(self) -> None:
        ...
        if state is None:
            return
        try:
            from pm_copilot_engine.agent.credits_tracker import evaluate_credits_notices, is_free_tier_model
    ...
    def close(self) -> None:
        ...
        try:
            from pm_copilot_engine.tools.process_registry import process_registry
    ...
    def _build_system_prompt_parts(self, system_message: str = None) -> Dict[str, str]:
        ...
        from pm_copilot_engine.agent.system_prompt import build_system_prompt_parts
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        from pm_copilot_engine.agent.system_prompt import build_system_prompt
    ...
    def _sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import sanitize_api_messages
    ...
    def _drop_thinking_only_and_merge_users(
        ...
        *,
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import drop_thinking_only_and_merge_users
    ...
    def _cap_delegate_task_calls(tool_calls: list) -> list:
        ...
        """
        from pm_copilot_engine.tools.delegate_tool import _get_max_concurrent_children
    ...
    def _repair_tool_call(self, tool_name: str) -> str | None:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import repair_tool_call
        return repair_tool_call(self, tool_name)

    def _invalidate_system_prompt(self):
        """Forwarder — see ``agent.system_prompt.invalidate_system_prompt``."""
        from pm_copilot_engine.agent.system_prompt import invalidate_system_prompt
    ...
    def _create_openai_client(self, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import create_openai_client
    ...
    def _force_close_tcp_sockets(client: Any) -> int:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import force_close_tcp_sockets
    ...
    def _cleanup_dead_connections(self) -> bool:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import cleanup_dead_connections
    ...
    def _copilot_headers_for_request(self, *, is_vision: bool) -> dict:
        from pm_copilot_engine._internal.hermes_cli.copilot_auth import copilot_request_headers
    ...
    def _run_codex_stream(self, api_kwargs: dict, client: Any = None, on_first_delta: callable = None):
        ...
        from pm_copilot_engine.agent.codex_runtime import run_codex_stream
    ...
    def _run_codex_create_stream_fallback(self, api_kwargs: dict, client: Any = None):
        ...
        from pm_copilot_engine.agent.codex_runtime import run_codex_create_stream_fallback
    ...
    def _try_refresh_codex_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
            if self.provider == "openai-codex":
                from pm_copilot_engine._internal.hermes_cli.auth import resolve_codex_runtime_credentials

                singleton_now = resolve_codex_runtime_credentials(
                    refresh_if_expiring=False,
                )
            else:
                from pm_copilot_engine._internal.hermes_cli.auth import resolve_xai_oauth_runtime_credentials
    ...
    def _try_refresh_nous_client_credentials(
        ...
        *,
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.auth import resolve_nous_runtime_credentials
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.copilot_auth import resolve_copilot_token
    ...
    def _try_refresh_anthropic_client_credentials(self) -> bool:
        ...
        try:
            from pm_copilot_engine.agent.anthropic_adapter import resolve_anthropic_token, build_anthropic_client
        ...
        from pm_copilot_engine.agent.anthropic_adapter import _is_oauth_token
        self._is_anthropic_oauth = _is_oauth_token(new_token) if self.provider == "anthropic" else False
        return True

    def _apply_client_headers_for_base_url(self, base_url: str) -> None:
        from pm_copilot_engine.agent.auxiliary_client import (
        ...
        if base_url_host_matches(base_url, "openrouter.ai"):
            ...
            from pm_copilot_engine._internal.hermes_cli.models import copilot_default_headers
            ...
            from pm_copilot_engine.agent.auxiliary_client import _codex_cloudflare_headers
            ...
            _ph_headers = None
            try:
                from pm_copilot_engine.providers import get_provider_profile as _gpf2
    ...
    def _swap_credential(self, entry) -> None:
        ...
        if self.api_mode == "anthropic_messages":
            from pm_copilot_engine.agent.anthropic_adapter import build_anthropic_client, _is_oauth_token
    ...
    def _recover_with_credential_pool(
        ...
        *,
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import recover_with_credential_pool
    ...
    def _anthropic_messages_create(self, api_kwargs: dict):
        ...
        from pm_copilot_engine.agent.anthropic_adapter import sanitize_anthropic_kwargs
    ...
    def _rebuild_anthropic_client(self) -> None:
        ...
        if getattr(self, "provider", None) == "bedrock":
            from pm_copilot_engine.agent.anthropic_adapter import build_anthropic_bedrock_client
            region = getattr(self, "_bedrock_region", "us-east-1") or "us-east-1"
            self._anthropic_client = build_anthropic_bedrock_client(region)
        else:
            from pm_copilot_engine.agent.anthropic_adapter import build_anthropic_client
            self._anthropic_client = build_anthropic_client(
    ...
    def _interruptible_api_call(self, api_kwargs: dict):
        ...
        from pm_copilot_engine.agent.chat_completion_helpers import interruptible_api_call
    ...
    def _interruptible_streaming_api_call(
        ...
        from pm_copilot_engine.agent.chat_completion_helpers import interruptible_streaming_api_call
        return interruptible_streaming_api_call(self, api_kwargs, on_first_delta=on_first_delta)

    def _try_activate_fallback(self, reason: "FailoverReason | None" = None) -> bool:
        """Forwarder — see ``agent.chat_completion_helpers.try_activate_fallback``."""
        from pm_copilot_engine.agent.chat_completion_helpers import try_activate_fallback
    ...
    def _restore_primary_runtime(self) -> bool:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import restore_primary_runtime
    ...
    def _try_recover_primary_transport(
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import try_recover_primary_transport
    ...
    def _describe_image_for_anthropic_fallback(self, image_url: str, role: str) -> str:
        ...
        description = ""
        try:
            from pm_copilot_engine.tools.vision_tools import vision_analyze_tool
    ...
    def _model_supports_vision(self) -> bool:
        ...
        try:
            ...
            from pm_copilot_engine.agent.image_routing import _lookup_supports_vision
            cfg = load_config()
    ...
    def _get_transport(self, api_mode: str = None):
        ...
        t = cache.get(mode)
        if t is None:
            from pm_copilot_engine.agent.transports import get_transport
    ...
    def _try_shrink_image_parts_in_messages(self, api_messages: list) -> bool:
        ...
        from pm_copilot_engine.agent.conversation_compression import try_shrink_image_parts_in_messages
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        from pm_copilot_engine.agent.chat_completion_helpers import build_api_kwargs
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from pm_copilot_engine._internal.hermes_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from pm_copilot_engine._internal.hermes_cli.models import lmstudio_model_reasoning_options
    ...
    def _resolve_lmstudio_summary_reasoning_effort(self) -> Optional[str]:
        ...
        """
        from pm_copilot_engine.agent.lmstudio_reasoning import resolve_lmstudio_effort
    ...
    def _build_assistant_message(self, assistant_message, finish_reason: str) -> dict:
        ...
        from pm_copilot_engine.agent.chat_completion_helpers import build_assistant_message
    ...
    def _copy_reasoning_content_for_api(self, source_msg: dict, api_msg: dict) -> None:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import copy_reasoning_content_for_api
    ...
    def _reapply_reasoning_echo_for_provider(self, api_messages: list) -> int:
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import reapply_reasoning_echo_for_provider
    ...
    def _sanitize_tool_calls_for_strict_api(api_msg: dict, model: "str | None" = None) -> dict:
        ...
        if not isinstance(tool_calls, list):
            return api_msg
        from pm_copilot_engine.agent.transports.chat_completions import _model_consumes_thought_signature
    ...
    def _sanitize_tool_call_arguments(
        ...
        *,
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import sanitize_tool_call_arguments
    ...
    def _compress_context(self, messages: list, system_message: str, *, approx_tokens: int = None, task_id: str = "default", focus_topic: str = None, force: bool = False) -> tuple:
        ...
        ``force=False``.
        """
        from pm_copilot_engine.agent.conversation_compression import compress_context
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        """
        from pm_copilot_engine.tools.delegate_tool import delegate_task as _delegate_task
    ...
    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str,
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import invoke_tool
        return invoke_tool(
            self,
            function_name,
            function_args,
    ...
    def _execute_tool_calls_concurrent(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
        ...
        from pm_copilot_engine.agent.tool_executor import execute_tool_calls_concurrent
    ...
    def _execute_tool_calls_sequential(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
        ...
        from pm_copilot_engine.agent.tool_executor import execute_tool_calls_sequential
    ...
    def _handle_max_iterations(self, messages: list, api_call_count: int) -> str:
        ...
        from pm_copilot_engine.agent.chat_completion_helpers import handle_max_iterations
    ...
    def _run_codex_app_server_turn(
        ...
        *,
        ...
        from pm_copilot_engine.agent.codex_runtime import run_codex_app_server_turn
...
def main(
    ...
    # Handle tool listing
    if list_tools:
        from pm_copilot_engine.model_tools import get_all_tool_names, get_available_toolsets
        from pm_copilot_engine.toolsets import get_all_toolsets, get_toolset_info
