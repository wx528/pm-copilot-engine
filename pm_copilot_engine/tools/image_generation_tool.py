...
def _load_fal_client() -> Any:
    ...
    if fal_client is not None:
        return fal_client
    from pm_copilot_engine.tools.fal_common import import_fal_client
    fal_client = import_fal_client()
    return fal_client


from pm_copilot_engine.tools.debug_helpers import DebugSession
from pm_copilot_engine.tools.fal_common import (
...
def _active_terminal_env(task_id: str | None):
    try:
        from pm_copilot_engine.tools.terminal_tool import get_active_env
...
def _agent_visible_cache_path(host_path: str, env: Any) -> str | None:
    ...
    try:
        from pm_copilot_engine.tools.credential_files import map_cache_path_to_container
