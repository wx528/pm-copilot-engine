...
# ---------------------------------------------------------------------------
from pm_copilot_engine.tools.interrupt import is_interrupted, _interrupt_event  # noqa: F401 — re-exported
...
from pm_copilot_engine.tools.environments.singularity import _get_scratch_dir
from pm_copilot_engine.tools.tool_backend_helpers import (
    coerce_modal_mode,
...
from pm_copilot_engine.tools.approval import (
...
from pm_copilot_engine.tools.environments.local import LocalEnvironment as _LocalEnvironment
from pm_copilot_engine.tools.environments.singularity import SingularityEnvironment as _SingularityEnvironment
from pm_copilot_engine.tools.environments.ssh import SSHEnvironment as _SSHEnvironment
from pm_copilot_engine.tools.environments.docker import DockerEnvironment as _DockerEnvironment
from pm_copilot_engine.tools.environments.modal import ModalEnvironment as _ModalEnvironment
from pm_copilot_engine.tools.environments.managed_modal import ManagedModalEnvironment as _ManagedModalEnvironment
...
def _maybe_reap_docker_orphans(container_config: Dict[str, Any]) -> None:
    ...
    * ``_docker_orphan_reaper_ran`` flag — sweep runs once per Python
    ...
    try:
        from pm_copilot_engine.tools.environments.docker import (
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    if env_type == "local":
        ...
        from pm_copilot_engine.tools.environments.daytona import DaytonaEnvironment as _DaytonaEnvironment
...
def _cleanup_inactive_envs(lifetime_seconds: int = 300):
    ...
    for task_id, env in envs_to_stop:
        ...
        try:
            from pm_copilot_engine.tools.file_tools import clear_file_ops_cache
...
def terminal_tool(
    ...
    try:
        ...
        if background:
            ...
            from pm_copilot_engine.tools.approval import get_current_session_key
            from pm_copilot_engine.tools.process_registry import process_registry
            ...
            try:
                from pm_copilot_engine._internal.hermes_cli.plugins import invoke_hook
            ...
            from pm_copilot_engine.tools.tool_output_limits import get_max_bytes
            ...
            from pm_copilot_engine.tools.ansi_strip import strip_ansi
...
def check_terminal_requirements() -> bool:
    ...
    try:
        ...
        if env_type == "local":
            ...
            from pm_copilot_engine.tools.environments.docker import find_docker
            docker = find_docker()
            if not docker:
