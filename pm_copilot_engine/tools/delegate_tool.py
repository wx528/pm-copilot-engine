...
from pm_copilot_engine.tools.terminal_tool import set_approval_callback as _set_subagent_approval_cb
    ...
    *,
    ...
    def _callback(
        ...
        if spinner:
            ...
            from pm_copilot_engine.agent.display import get_tool_emoji
...
def delegate_task(
    ...
    import pm_copilot_engine.model_tools as _model_tools
...
def _resolve_child_credential_pool(
    ...
    if effective_provider == "custom":
        try:
            from pm_copilot_engine.agent.credential_pool import get_custom_provider_pool_key, load_pool
