...
import httpx
from pm_copilot_engine.agent.auxiliary_client import async_call_llm, extract_content_or_reasoning
...
async def _validate_image_url_async(url: str) -> bool:
    ...
    if not _image_url_shape_ok(url):
        return False
    from pm_copilot_engine.tools.url_safety import async_is_safe_url
...
def _resize_image_for_vision(image_path: Path, mime_type: Optional[str] = None,
    ...
    try:
        ...
        try:
            from pm_copilot_engine.tools.lazy_deps import ensure as _ensure_dep
...
def _should_use_native_vision_fast_path() -> bool:
    ...
    """
    try:
        from pm_copilot_engine.agent.auxiliary_client import _read_main_provider, _read_main_model
        from pm_copilot_engine.agent.image_routing import decide_image_input_mode, _lookup_supports_vision
