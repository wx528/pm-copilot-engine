...
def _scrub_child_env(source_env, is_passthrough=None, is_windows=None):
    ...
    if is_passthrough is None:
        try:
            from pm_copilot_engine.tools.env_passthrough import is_env_passthrough as _ep
        except Exception:
...
def _rpc_server_loop(
    ...
    """
    from pm_copilot_engine.model_tools import handle_function_call
...
def execute_code(
    ...
    from pm_copilot_engine.tools.terminal_tool import _get_env_config
    ...
    from pm_copilot_engine.tools.approval import check_execute_code_guard
    ...
    from pm_copilot_engine.tools.interrupt import is_interrupted as _is_interrupted
    ...
    try:
        ...
        from pm_copilot_engine.hermes_constants import get_subprocess_home
        ...
        while proc.poll() is None:
            ...
            try:
                from pm_copilot_engine.tools.environments.base import touch_activity_if_due
