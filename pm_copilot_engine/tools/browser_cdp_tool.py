...
def _resolve_cdp_endpoint() -> str:
    ...
    """
    try:
        from pm_copilot_engine.tools.browser_tool import _get_cdp_override  # type: ignore[import-not-found]
...
def _browser_cdp_check() -> bool:
    ...
    """
    try:
        from pm_copilot_engine.tools.browser_tool import (  # type: ignore[import-not-found]
            _get_cdp_override,
