...
from pm_copilot_engine.tools.browser_supervisor import SUPERVISOR_REGISTRY
...
def _browser_dialog_check() -> bool:
    ...
    """
    try:
        from pm_copilot_engine.tools.browser_cdp_tool import _browser_cdp_check  # type: ignore[import-not-found]
