...
from pm_copilot_engine.tools.environments.base import BaseEnvironment, _popen_bash
from pm_copilot_engine.tools.environments.local import _HERMES_PROVIDER_ENV_BLOCKLIST
...
class DockerEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        from pm_copilot_engine.tools.environments.base import get_sandbox_dir
        ...
        try:
            from pm_copilot_engine.tools.credential_files import (
    ...
    def _build_init_env_args(self) -> list[str]:
        ...
        try:
            from pm_copilot_engine.tools.env_passthrough import get_all_passthrough
