...
class BaseEnvironment(ABC):
    ...
    def execute(
        ...
        *,
        ...
        if rewrite_compound_background:
            from pm_copilot_engine.tools.terminal_tool import _rewrite_compound_background
    ...
    def _prepare_command(self, command: str) -> tuple[str, str | None]:
        ...
        from pm_copilot_engine.tools.terminal_tool import _transform_sudo_command
