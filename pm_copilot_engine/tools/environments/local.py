...
from pm_copilot_engine.tools.environments.base import BaseEnvironment, _pipe_stdin
...
def _build_provider_env_blocklist() -> frozenset:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.config import OPTIONAL_ENV_VARS
...
def _inject_context_hermes_home(env: dict) -> None:
    ...
    try:
        from pm_copilot_engine.hermes_constants import get_hermes_home_override
...
def _sanitize_subprocess_env(base_env: dict | None, extra_env: dict | None = None) -> dict:
    ...
    try:
        from pm_copilot_engine.tools.env_passthrough import is_env_passthrough as _is_passthrough
    except Exception:
