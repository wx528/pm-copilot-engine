...
def write_approval_enabled(subsystem: str) -> bool:
    ...
    if subsystem not in _SUBSYSTEMS:
        return False
    try:
        from pm_copilot_engine._internal.hermes_cli.config import load_config, cfg_get
        cfg = load_config()
...
def current_origin() -> str:
    ...
    """
    try:
        from pm_copilot_engine.tools.skill_provenance import get_current_write_origin
