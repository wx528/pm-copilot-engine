...
from pm_copilot_engine.hermes_constants import get_bundled_skills_dir, get_hermes_home, get_optional_skills_dir
...
def _read_suppressed_names() -> set:
    ...
    """
    try:
        from pm_copilot_engine.tools.skill_usage import read_suppressed_names
...
def _content_hash(directory: Path) -> str:
    ...
    try:
        from pm_copilot_engine.tools.skills_guard import content_hash
