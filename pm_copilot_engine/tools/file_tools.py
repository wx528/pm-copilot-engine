...
from pm_copilot_engine.agent.file_safety import get_read_block_error
from pm_copilot_engine.tools.binary_extensions import has_binary_extension
from pm_copilot_engine.tools.file_operations import (
    ShellFileOperations,
    normalize_read_pagination,
    normalize_search_pagination,
)
from pm_copilot_engine.tools import file_state
...
def _get_live_tracking_cwd(task_id: str = "default") -> str | None:
    ...
    try:
        from pm_copilot_engine.tools.terminal_tool import _resolve_container_task_id
    ...
    try:
        from pm_copilot_engine.tools.terminal_tool import _active_environments, _env_lock
...
def _get_file_ops(task_id: str = "default") -> ShellFileOperations:
    ...
    with task_lock:
        ...
        if terminal_env is None:
            from pm_copilot_engine.tools.terminal_tool import _task_env_overrides
...
def read_file_tool(path: str, offset: int = 1, limit: int = 500, task_id: str = "default") -> str:
    ...
    try:
        ...
        from pm_copilot_engine.tools.read_extract import ExtractionError, extract_document_text, is_extractable_document
...
def _check_file_reqs():
    ...
    from pm_copilot_engine.tools import check_file_requirements
