...
from pm_copilot_engine.utils import env_var_enabled, is_truthy_value
...
def prompt_dangerous_approval(command: str, description: str,
    ...
    try:
        ...
        from pm_copilot_engine.agent.i18n import t
        while True:
            print()
...
def check_all_command_guards(command: str, env_type: str,
    ...
    try:
        from pm_copilot_engine.tools.tirith_security import check_command_security
