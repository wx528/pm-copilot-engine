...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        from pm_copilot_engine.tools.mcp_oauth import (
            HermesTokenStorage,
            _OAUTH_AVAILABLE,
    ...
    def remove(self, server_name: str) -> None:
        ...
        from pm_copilot_engine.tools.mcp_oauth import remove_oauth_tokens
    ...
    async def invalidate_if_disk_changed(self, server_name: str) -> bool:
        ...
        """
        from pm_copilot_engine.tools.mcp_oauth import _get_token_dir, _safe_filename
