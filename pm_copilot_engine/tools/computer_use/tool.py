...
from pm_copilot_engine.tools.computer_use.backend import (
    ActionResult,
    CaptureResult,
    ComputerUseBackend,
    UIElement,
    ...
    with _backend_lock:
        if _backend is None:
            ...
            if backend_name in {"cua", "cua-driver", ""}:
                from pm_copilot_engine.tools.computer_use.cua_backend import CuaDriverBackend
...
def _should_route_through_aux_vision() -> bool:
    ...
    """
    try:
        from pm_copilot_engine.agent.auxiliary_client import _read_main_model, _read_main_provider
        from pm_copilot_engine._internal.hermes_cli.config import load_config
        from pm_copilot_engine.tools.computer_use.vision_routing import (
...
def check_computer_use_requirements() -> bool:
    ...
    if sys.platform != "darwin":
        return False
    from pm_copilot_engine.tools.computer_use.cua_backend import cua_driver_binary_available
    return cua_driver_binary_available()


def get_computer_use_schema() -> Dict[str, Any]:
    from pm_copilot_engine.tools.computer_use.schema import COMPUTER_USE_SCHEMA
