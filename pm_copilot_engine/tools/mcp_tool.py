    ...
    if os.sep not in resolved_command:
        ...
        if which_hit:
            ...
            hermes_home = os.path.expanduser(
                os.getenv(
                    "PM_COPILOT_HOME", os.path.join(os.path.expanduser("~"), ".hermes")
                )
            )
            candidates = [
...
class MCPServerTask:
    ...
    async def _run_stdio(self, config: dict):
        ...
        from pm_copilot_engine.tools.osv_check import check_package_for_malware
...
def _get_auth_error_types() -> tuple:
    ...
    try:
        ...
        pass
    try:
        from pm_copilot_engine.tools.mcp_oauth import OAuthNonInteractiveError
...
def _load_mcp_config() -> Dict[str, dict]:
    ...
    try:
        ...
        from pm_copilot_engine.utils import env_var_enabled as _env_enabled
...
def _make_read_resource_handler(server_name: str, tool_timeout: float):
    ...
    def _handler(args: dict, **kwargs) -> str:
        from pm_copilot_engine.tools.registry import tool_error
...
def _normalize_mcp_input_schema(schema: dict | None) -> dict:
    ...
    * MCP/Pydantic optional fields commonly arrive as
    ...
    def _strip_nullable_union(node):
        ...
        """
        from pm_copilot_engine.tools.schema_sanitizer import strip_nullable_unions
...
def register_mcp_servers(servers: Dict[str, dict]) -> List[str]:
    ...
    from pm_copilot_engine.tools.interrupt import is_interrupted as _is_interrupted, set_interrupt as _set_interrupt
