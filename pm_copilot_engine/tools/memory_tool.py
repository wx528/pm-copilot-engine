...
from pm_copilot_engine.tools.threat_patterns import first_threat_message as _first_threat_message
...
class MemoryStore:
    ...
    def _sanitize_entries_for_snapshot(entries: List[str], filename: str) -> List[str]:
        ...
        """
        from pm_copilot_engine.tools.threat_patterns import scan_for_threats
