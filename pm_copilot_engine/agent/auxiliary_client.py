...
from pm_copilot_engine.hermes_constants import OPENROUTER_BASE_URL
from pm_copilot_engine.utils import base_url_host_matches, base_url_hostname, model_forces_max_completion_tokens, normalize_proxy_env_vars
...
def _apply_user_default_headers(headers: dict | None) -> dict | None:
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.config import cfg_get, load_config
...
#
# The tags are computed from pm_copilot_engine.agent.portal_tags so the client= marker stays
...
from pm_copilot_engine.agent.portal_tags import nous_portal_tags as _nous_portal_tags
...
class _CodexCompletionsAdapter:
    ...
    def create(self, **kwargs) -> Any:
        ...
        from pm_copilot_engine.agent.codex_responses_adapter import _chat_messages_to_responses_input
        ...
        if tools:
            ...
            try:
                ...
                from pm_copilot_engine.tools.schema_sanitizer import (
        ...
        try:
            ...
            from pm_copilot_engine.agent.codex_runtime import _consume_codex_event_stream
...
class _AnthropicCompletionsAdapter:
    ...
    def create(self, **kwargs) -> Any:
        from pm_copilot_engine.agent.anthropic_adapter import build_anthropic_kwargs
        ...
        if temperature is not None:
            from pm_copilot_engine.agent.anthropic_adapter import _forbids_sampling_params
...
def _maybe_wrap_anthropic(
    ...
    if _safe_isinstance(client_obj, CodexAuxiliaryClient):
        return client_obj
    try:
        from pm_copilot_engine.agent.gemini_native_adapter import GeminiNativeClient
        if _safe_isinstance(client_obj, GeminiNativeClient):
            return client_obj
    except ImportError:
        pass
    try:
        from pm_copilot_engine.agent.copilot_acp_client import CopilotACPClient
...
def _nous_api_key(provider: dict) -> str:
    ...
    from pm_copilot_engine._internal.hermes_cli.auth import _nous_invoke_jwt_is_usable
...
def _read_codex_access_token() -> Optional[str]:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.auth import _read_codex_tokens
...
def _resolve_api_key_provider() -> Tuple[Optional[OpenAI], Optional[str]]:
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.auth import PROVIDER_REGISTRY, resolve_api_key_provider_credentials
    except ImportError:
    ...
    for provider_id, pconfig in PROVIDER_REGISTRY.items():
        ...
        if provider_id == "anthropic":
            ...
            try:
                from pm_copilot_engine._internal.hermes_cli.auth import is_provider_explicitly_configured
        ...
        if pool_present:
            ...
            if provider_id == "gemini":
                from pm_copilot_engine.agent.gemini_native_adapter import GeminiNativeClient, is_native_gemini_base_url
            ...
            if base_url_host_matches(base_url, "api.kimi.com"):
                ...
                try:
                    from pm_copilot_engine.providers import get_provider_profile as _gpf_aux
        ...
        if base_url_host_matches(base_url, "api.kimi.com"):
            ...
            try:
                from pm_copilot_engine.providers import get_provider_profile as _gpf_aux2
...
def _try_nous(vision: bool = False) -> Tuple[Optional[OpenAI], Optional[str]]:
    ...
    try:
        from pm_copilot_engine.agent.nous_rate_guard import nous_rate_limit_remaining
    ...
    model = _NOUS_MODEL
    try:
        from pm_copilot_engine._internal.hermes_cli.models import get_nous_recommended_aux_model
...
def _resolve_custom_runtime() -> Tuple[Optional[str], Optional[str], Optional[str]]:
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.runtime_provider import resolve_runtime_provider
...
def _try_azure_foundry(
    ...
    * Non-default ``model.base_url`` overrides are honored.
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.runtime_provider import _resolve_azure_foundry_runtime
        from pm_copilot_engine._internal.hermes_cli.auth import AuthError
        from pm_copilot_engine._internal.hermes_cli.config import load_config
    except ImportError:
        return None, None
...
def _try_anthropic(explicit_api_key: str = None) -> Tuple[Optional[Any], Optional[str]]:
    try:
        from pm_copilot_engine.agent.anthropic_adapter import build_anthropic_client, resolve_anthropic_token
    except ImportError:
        return None, None
...
def _nous_portal_account_has_fresh_paid_access() -> bool:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.nous_account import get_nous_portal_account_info
...
def _refresh_provider_credentials(provider: str) -> bool:
    ...
    try:
        ...
        if normalized == "anthropic":
            from pm_copilot_engine.agent.anthropic_adapter import read_claude_code_credentials, _refresh_oauth_token, resolve_anthropic_token
...
def _to_async_client(sync_client, model: str, is_vision: bool = False):
    ...
    try:
        from pm_copilot_engine.agent.gemini_native_adapter import GeminiNativeClient, AsyncGeminiNativeClient
    ...
    if base_url_host_matches(sync_base_url, "openrouter.ai"):
        ...
        try:
            from pm_copilot_engine.agent.model_metadata import _infer_provider_from_url
            from pm_copilot_engine.providers import get_provider_profile as _gpf_async
...
def resolve_provider_client(
    ...
    if provider == "custom":
        if explicit_base_url:
            ...
            if base_url_host_matches(custom_base, "api.kimi.com"):
                ...
                try:
                    from pm_copilot_engine.providers import get_provider_profile as _gpf_custom
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.runtime_provider import _get_named_custom_provider
    ...
    if pconfig.auth_type == "api_key":
        ...
        if base_url_host_matches(base_url, "api.kimi.com"):
            ...
            try:
                from pm_copilot_engine.providers import get_provider_profile as _gpf_main
    ...
    if pconfig.auth_type == "external_process":
        ...
        try:
            from pm_copilot_engine.agent.bedrock_adapter import has_aws_credentials, resolve_bedrock_region
