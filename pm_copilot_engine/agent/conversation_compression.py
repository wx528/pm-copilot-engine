...
from pm_copilot_engine.agent.model_metadata import estimate_request_tokens_rough
...
def compress_context(
    ...
    *,
    ...
    try:
        from pm_copilot_engine.tools.file_tools import reset_file_dedup
...
def try_shrink_image_parts_in_messages(api_messages: list) -> bool:
    ...
    try:
        from pm_copilot_engine.tools.vision_tools import _resize_image_for_vision
    except Exception as exc:
