...
from pm_copilot_engine.agent.transports.base import ProviderTransport
from pm_copilot_engine.agent.transports.types import NormalizedResponse, ToolCall
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def _resolve_issuer_kind(self, params: Dict[str, Any]) -> str:
        ...
        from pm_copilot_engine.agent.codex_responses_adapter import _classify_responses_issuer
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from pm_copilot_engine.agent.codex_responses_adapter import _responses_tools
    ...
    def build_kwargs(
        ...
        **params,
        ...
        from pm_copilot_engine.run_agent import DEFAULT_AGENT_IDENTITY
        ...
        if reasoning_enabled and is_xai_responses:
            from pm_copilot_engine.agent.model_metadata import grok_supports_reasoning_effort
    ...
    def preflight_kwargs(self, api_kwargs: Any, *, allow_stream: bool = False) -> dict:
        ...
        """
        from pm_copilot_engine.agent.codex_responses_adapter import _preflight_codex_api_kwargs
...
from pm_copilot_engine.agent.transports import register_transport  # noqa: E402
