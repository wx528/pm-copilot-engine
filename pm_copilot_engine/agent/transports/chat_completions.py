...
from pm_copilot_engine.agent.moonshot_schema import is_moonshot_model, sanitize_moonshot_tools
from pm_copilot_engine.agent.prompt_builder import DEVELOPER_ROLE_MODELS
from pm_copilot_engine.agent.transports.base import ProviderTransport
from pm_copilot_engine.agent.transports.types import NormalizedResponse, ToolCall, Usage
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        """
        from pm_copilot_engine.providers.base import OMIT_TEMPERATURE
        ...
        if extra_body:
            ...
            try:
                from pm_copilot_engine.agent.gemini_native_adapter import is_native_gemini_base_url
