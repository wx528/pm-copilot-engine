...
def _run_review_in_thread(
    ...
    from pm_copilot_engine.tools.terminal_tool import set_approval_callback as _set_approval_callback
    ...
    try:
        with open(os.devnull, "w", encoding="utf-8") as _devnull, \
            ...
            from pm_copilot_engine.model_tools import get_tool_definitions
