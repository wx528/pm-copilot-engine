...
from pm_copilot_engine.agent.anthropic_adapter import _is_oauth_token, resolve_anthropic_token
from pm_copilot_engine._internal.hermes_cli.auth import _read_codex_tokens, resolve_codex_runtime_credentials
...
def build_nous_credits_snapshot(account_info) -> Optional[AccountUsageSnapshot]:
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.nous_account import nous_portal_topup_url
