...
from pm_copilot_engine.agent.skill_preprocessing import (
...
def _load_skill_payload(skill_identifier: str, task_id: str | None = None) -> tuple[dict[str, Any], Path | None, str] | None:
    ...
    try:
        from pm_copilot_engine.tools.skills_tool import SKILLS_DIR, skill_view
...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    """
    try:
        from pm_copilot_engine.agent.skill_utils import (
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    ...
    _skill_commands = {}
    try:
        from pm_copilot_engine.tools.skills_tool import SKILLS_DIR, _parse_frontmatter, skill_matches_platform, skill_matches_environment, _get_disabled_skill_names
