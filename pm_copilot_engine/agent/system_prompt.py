...
from pm_copilot_engine.agent.prompt_builder import (
...
from pm_copilot_engine.agent.runtime_cwd import resolve_context_cwd
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if "computer_use" in agent.valid_tool_names:
        from pm_copilot_engine.agent.prompt_builder import COMPUTER_USE_GUIDANCE
    ...
    if has_skills_tools:
        ...
        try:
            from pm_copilot_engine.agent.coding_context import coding_compact_skill_categories
    ...
    if agent.valid_tool_names:
        try:
            from pm_copilot_engine.agent.coding_context import coding_system_blocks
    ...
    if getattr(agent, "_environment_probe", True):
        try:
            from pm_copilot_engine.tools.env_probe import get_environment_probe_line
