...
from pm_copilot_engine.agent.display import (
    KawaiiSpinner,
...
from pm_copilot_engine.agent.tool_guardrails import ToolGuardrailDecision
...
from pm_copilot_engine.tools.terminal_tool import (
    get_active_env,
)
from pm_copilot_engine.tools.thread_context import propagate_context_to_thread
from pm_copilot_engine.tools.tool_result_storage import (
...
def execute_tool_calls_concurrent(agent, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
    ...
    def _run_tool(index, tool_call, function_name, function_args, middleware_trace):
        ...
        try:
            from pm_copilot_engine.tools.environments.base import set_activity_callback
...
def execute_tool_calls_sequential(agent, assistant_message, messages: list, effective_task_id: str, api_call_count: int = 0) -> None:
    ...
    for i, tool_call in enumerate(assistant_message.tool_calls, 1):
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import agent_runtime_owns_post_tool_hook
