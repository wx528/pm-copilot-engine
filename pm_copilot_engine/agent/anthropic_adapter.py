...
from pm_copilot_engine.utils import base_url_host_matches, normalize_proxy_env_vars
...
def _build_anthropic_client_with_bearer_hook(
    ...
    *,
    ...
    from pm_copilot_engine.agent.azure_identity_adapter import build_bearer_http_client
...
def run_hermes_oauth_login_pure() -> Optional[Dict[str, Any]]:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.auth import _can_open_graphical_browser as _can_open_gui
    except Exception:
