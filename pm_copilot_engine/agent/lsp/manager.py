...
from pm_copilot_engine.agent.lsp import eventlog
from pm_copilot_engine.agent.lsp.client import (
    DIAGNOSTICS_DOCUMENT_WAIT,
    LSPClient,
)
from pm_copilot_engine.agent.lsp.servers import (
    ServerContext,
    find_server_for_file,
    language_id_for,
)
from pm_copilot_engine.agent.lsp.workspace import (
    clear_cache,
        ...
        if delta:
            ...
            if baseline:
                if line_shift is not None:
                    ...
                    from pm_copilot_engine.agent.lsp.range_shift import shift_baseline
