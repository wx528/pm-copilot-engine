...
def _cmd_status(emit_json: bool) -> int:
    ...
    from pm_copilot_engine.agent.lsp.install import detect_status
...
def _cmd_install(server_id: str) -> int:
    from pm_copilot_engine.agent.lsp.install import try_install, INSTALL_RECIPES, detect_status
...
def _cmd_restart() -> int:
    from pm_copilot_engine.agent.lsp import shutdown_service
...
def _cmd_which(server_id: str) -> int:
    from pm_copilot_engine.agent.lsp.install import INSTALL_RECIPES, _existing_binary
...
def _backend_warnings() -> list:
    ...
    from pm_copilot_engine.agent.lsp.install import _existing_binary
    notes: list = []
