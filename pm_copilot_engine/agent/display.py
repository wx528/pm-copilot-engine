...
from pm_copilot_engine.utils import safe_json_loads
from pm_copilot_engine.agent.tool_result_classification import file_mutation_result_landed
...
def _resolve_skill_manage_paths(args: dict) -> list[Path]:
    ...
    from pm_copilot_engine.tools.skill_manager_tool import _find_skill, _resolve_skill_dir
