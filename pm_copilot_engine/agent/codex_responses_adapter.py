...
Extracted from pm_copilot_engine.run_agent.py to isolate Responses API-specific logic from the
...
from pm_copilot_engine.agent.prompt_builder import DEFAULT_AGENT_IDENTITY
...
def _preflight_codex_api_kwargs(
    ...
    *,
    ...
    if is_xai_model and normalized.get("tools"):
        try:
            from pm_copilot_engine.tools.schema_sanitizer import strip_slash_enum
