...
from pm_copilot_engine.hermes_constants import get_hermes_home, get_skills_dir, is_wsl
from typing import Optional

from pm_copilot_engine.agent.runtime_cwd import resolve_agent_cwd
...
from pm_copilot_engine.tools.threat_patterns import scan_for_threats as _scan_for_threats
...
def _probe_remote_backend(env_type: str) -> str | None:
    ...
    try:
        ...
        from pm_copilot_engine.tools.terminal_tool import _get_env_config  # type: ignore
        from pm_copilot_engine.tools.environments import get_environment  # type: ignore
...
def load_soul_md() -> Optional[str]:
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.config import ensure_hermes_home
        ensure_hermes_home()
    except Exception as e:
