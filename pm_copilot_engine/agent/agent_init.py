...
from pm_copilot_engine.agent.context_compressor import ContextCompressor
from pm_copilot_engine.agent.iteration_budget import IterationBudget
from pm_copilot_engine.agent.memory_manager import StreamingContextScrubber
...
from pm_copilot_engine.agent.process_bootstrap import _install_safe_stdio
from pm_copilot_engine.agent.subdirectory_hints import SubdirectoryHintTracker
from pm_copilot_engine.agent.think_scrubber import StreamingThinkScrubber
from pm_copilot_engine.agent.tool_guardrails import (
    ToolCallGuardrailConfig,
    ToolCallGuardrailController,
    ToolGuardrailDecision,
)
from pm_copilot_engine._internal.hermes_cli.config import cfg_get
from pm_copilot_engine._internal.hermes_cli.timeouts import get_provider_request_timeout
from pm_copilot_engine.hermes_constants import get_hermes_home
from pm_copilot_engine.utils import base_url_host_matches
...
def init_agent(
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.model_normalize import (
    ...
    agent._cache_ttl = "5m"
    try:
        from pm_copilot_engine._internal.hermes_cli.config import load_config as _load_pc_cfg
    ...
    from pm_copilot_engine.hermes_logging import setup_logging, setup_verbose_logging
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        if _is_bedrock_anthropic:
            ...
            if agent.provider == "minimax-oauth" and isinstance(effective_key, str) and effective_key:
                try:
                    from pm_copilot_engine._internal.hermes_cli.auth import build_minimax_oauth_token_provider
            ...
            from pm_copilot_engine.agent.anthropic_adapter import _is_oauth_token as _is_oat
            ...
            if not agent.quiet_mode:
                ...
                from pm_copilot_engine.agent.azure_identity_adapter import is_token_provider
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.config import load_config as _load_br_cfg
        ...
        if api_key and base_url:
            ...
            if base_url_host_matches(effective_base, "openrouter.ai"):
                from pm_copilot_engine.agent.auxiliary_client import build_or_headers
                client_kwargs["default_headers"] = build_or_headers()
            elif base_url_host_matches(effective_base, "integrate.api.nvidia.com"):
                from pm_copilot_engine.agent.auxiliary_client import build_nvidia_nim_headers
                ...
                # endpoints).
                try:
                    from pm_copilot_engine.providers import get_provider_profile as _gpf
            ...
            from pm_copilot_engine.agent.auxiliary_client import resolve_provider_client
    ...
    from pm_copilot_engine.agent.prompt_builder import KANBAN_GUIDANCE
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.config import load_config as _load_sess_cfg
    ...
    from pm_copilot_engine.tools.checkpoint_manager import CheckpointManager
    ...
    from pm_copilot_engine.tools.todo_tool import TodoStore
    agent._todo_store = TodoStore()
    
    # Load config once for memory, skills, and compression sections
    try:
        from pm_copilot_engine._internal.hermes_cli.config import load_config as _load_agent_config
    ...
    if not skip_memory:
        try:
            ...
            if agent._memory_enabled or agent._user_profile_enabled:
                from pm_copilot_engine.tools.memory_tool import MemoryStore
    ...
    if not skip_memory:
        try:
            ...
            if _mem_provider_name and _mem_provider_name.strip():
                from pm_copilot_engine.agent.memory_manager import MemoryManager as _MemoryManager
    ...
    from pm_copilot_engine.agent.memory_manager import inject_memory_provider_tools as _inject_memory_provider_tools
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.config import get_compatible_custom_providers
    ...
    if _config_context_length is None and _custom_providers:
        try:
            from pm_copilot_engine._internal.hermes_cli.config import get_custom_provider_context_length
    ...
    if _engine_name != "compressor":
        ...
        if _selected_engine is None:
            try:
                from pm_copilot_engine._internal.hermes_cli.plugins import get_plugin_context_engine
