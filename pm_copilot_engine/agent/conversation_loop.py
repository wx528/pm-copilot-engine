...
from pm_copilot_engine.agent.codex_responses_adapter import _summarize_user_message_for_log
from pm_copilot_engine.agent.display import KawaiiSpinner
from pm_copilot_engine.agent.error_classifier import FailoverReason, classify_api_error
from pm_copilot_engine.agent.iteration_budget import IterationBudget
from pm_copilot_engine.agent.turn_context import build_turn_context
from pm_copilot_engine.agent.turn_retry_state import TurnRetryState
from pm_copilot_engine.agent.memory_manager import build_memory_context_block
from pm_copilot_engine.agent.message_sanitization import (
...
from pm_copilot_engine.agent.prompt_caching import apply_anthropic_cache_control
from pm_copilot_engine.agent.retry_utils import jittered_backoff
from pm_copilot_engine.agent.trajectory import has_incomplete_scratchpad
from pm_copilot_engine.agent.usage_pricing import estimate_usage_cost, normalize_usage
from pm_copilot_engine.hermes_constants import PARTIAL_STREAM_STUB_ID
from pm_copilot_engine.hermes_logging import set_session_context
from pm_copilot_engine.tools.skill_provenance import set_current_write_origin
from pm_copilot_engine.utils import base_url_host_matches, env_var_enabled
...
def _restore_or_build_system_prompt(agent, system_message, conversation_history):
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.plugins import invoke_hook as _invoke_hook
        _invoke_hook(
            "on_session_start",
    ...
    try:
        from pm_copilot_engine.agent.credits_tracker import seed_credits_at_session_start
...
def run_conversation(
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        if _pre_api_steer:
            ...
            for _si in range(len(messages) - 1, -1, -1):
                ...
                if isinstance(_sm, dict) and _sm.get("role") == "tool":
                    from pm_copilot_engine.agent.prompt_builder import format_steer_marker
        ...
        from pm_copilot_engine.agent.agent_runtime_helpers import repair_message_sequence_with_cursor
        ...
        while retry_count < max_retries:
            ...
            if agent.provider == "nous":
                try:
                    from pm_copilot_engine.agent.nous_rate_guard import (
            ...
            try:
                ...
                try:
                    from pm_copilot_engine._internal.hermes_cli.middleware import apply_llm_request_middleware
                ...
                try:
                    from pm_copilot_engine._internal.hermes_cli.plugins import (
                        has_hook,
                ...
                from pm_copilot_engine._internal.hermes_cli.middleware import run_llm_execution_middleware
                ...
                if agent.provider == "nous":
                    try:
                        from pm_copilot_engine.agent.nous_rate_guard import clear_nous_rate_limit
                ...
                if (
                    ...
                    try:
                        from pm_copilot_engine.tools.schema_sanitizer import strip_pattern_and_format
    ...
    from pm_copilot_engine.agent.turn_finalizer import finalize_turn
