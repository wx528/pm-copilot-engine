...
def cmd_status(args: argparse.Namespace) -> int:
    from pm_copilot_engine.tools.checkpoint_manager import store_status
...
def cmd_prune(args: argparse.Namespace) -> int:
    from pm_copilot_engine.tools.checkpoint_manager import prune_checkpoints
...
def cmd_clear(args: argparse.Namespace) -> int:
    from pm_copilot_engine.tools.checkpoint_manager import CHECKPOINT_BASE, clear_all, store_status
...
def cmd_clear_legacy(args: argparse.Namespace) -> int:
    from pm_copilot_engine.tools.checkpoint_manager import clear_legacy, store_status
