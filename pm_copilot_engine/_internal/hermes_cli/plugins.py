...
from pm_copilot_engine._internal.hermes_cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
...
class PluginContext:
    ...
    def llm(self) -> Any:
        ...
        if self._llm is None:
            from pm_copilot_engine.agent.plugin_llm import PluginLlm
    ...
    def register_command(
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.commands import resolve_command
    ...
    def register_context_engine(self, engine) -> None:
        ...
        from pm_copilot_engine.agent.context_engine import ContextEngine
    ...
    def register_image_gen_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from pm_copilot_engine.agent.image_gen_provider import ImageGenProvider
        from pm_copilot_engine.agent.image_gen_registry import register_provider
    ...
    def register_dashboard_auth_provider(self, provider) -> None:
        ...
        """
        from pm_copilot_engine._internal.hermes_cli.dashboard_auth import (
    ...
    def register_video_gen_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from pm_copilot_engine.agent.video_gen_provider import VideoGenProvider
        from pm_copilot_engine.agent.video_gen_registry import register_provider as _register_video_provider
    ...
    def register_web_search_provider(self, provider) -> None:
        ...
        tool calls.
        """
        from pm_copilot_engine.agent.web_search_provider import WebSearchProvider
        from pm_copilot_engine.agent.web_search_registry import register_provider as _register_web_provider
    ...
    def register_browser_provider(self, provider) -> None:
        ...
        """
        from pm_copilot_engine.agent.browser_provider import BrowserProvider
        from pm_copilot_engine.agent.browser_registry import register_provider as _register_browser_provider
    ...
    def register_tts_provider(self, provider) -> None:
        ...
        """
        from pm_copilot_engine.agent.tts_provider import TTSProvider
        from pm_copilot_engine.agent.tts_registry import register_provider as _register_tts_provider
    ...
    def register_transcription_provider(self, provider) -> None:
        ...
        **but only when**:
        ...
        backends).
        """
        from pm_copilot_engine.agent.transcription_provider import TranscriptionProvider
        from pm_copilot_engine.agent.transcription_registry import register_provider as _register_stt_provider
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        from pm_copilot_engine._internal.hermes_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
    ...
    def register_skill(
        ...
        """
        from pm_copilot_engine.agent.skill_utils import _NAMESPACE_RE
