...
def _query_codex_plugins(
    ...
    """
    try:
        from pm_copilot_engine.agent.transports.codex_app_server import CodexAppServerClient
...
def _build_hermes_tools_mcp_entry() -> dict:
    ...
    hermes_home = os.environ.get("PM_COPILOT_HOME") or ""
    if hermes_home and _looks_like_test_tempdir(hermes_home):
        hermes_home = ""
    if hermes_home:
        env["PM_COPILOT_HOME"] = hermes_home
