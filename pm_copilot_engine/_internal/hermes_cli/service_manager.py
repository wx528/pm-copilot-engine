...
class SystemdServiceManager(_RegistrationUnsupportedMixin):
    ...
    def start(self, name: str) -> None:
        from pm_copilot_engine._internal.hermes_cli.gateway import systemd_start
        systemd_start()

    def stop(self, name: str) -> None:
        from pm_copilot_engine._internal.hermes_cli.gateway import systemd_stop
        systemd_stop()

    def restart(self, name: str) -> None:
        from pm_copilot_engine._internal.hermes_cli.gateway import systemd_restart
        systemd_restart()

    def is_running(self, name: str) -> bool:
        from pm_copilot_engine._internal.hermes_cli.gateway import _probe_systemd_service_running
...
class LaunchdServiceManager(_RegistrationUnsupportedMixin):
    ...
    def start(self, name: str) -> None:
        from pm_copilot_engine._internal.hermes_cli.gateway import launchd_start
        launchd_start()

    def stop(self, name: str) -> None:
        from pm_copilot_engine._internal.hermes_cli.gateway import launchd_stop
        launchd_stop()

    def restart(self, name: str) -> None:
        from pm_copilot_engine._internal.hermes_cli.gateway import launchd_restart
        launchd_restart()

    def is_running(self, name: str) -> bool:
        from pm_copilot_engine._internal.hermes_cli.gateway import _probe_launchd_service_running
...
class WindowsServiceManager(_RegistrationUnsupportedMixin):
    ...
    def is_running(self, name: str) -> bool:
        from pm_copilot_engine._internal.hermes_cli import gateway_windows
        from pm_copilot_engine._internal.hermes_cli.gateway import find_gateway_pids
