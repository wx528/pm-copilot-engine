...
from pm_copilot_engine.hermes_constants import get_hermes_home, get_optional_mcps_dir
...
from pm_copilot_engine._internal.hermes_cli.cli_output import prompt as _prompt_input
...
def _probe_tools(name: str) -> Optional[List[tuple]]:
    ...
    try:
        ...
        from pm_copilot_engine._internal.hermes_cli.mcp_config import _probe_single_server
