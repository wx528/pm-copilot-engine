...
from pm_copilot_engine.agent.skill_utils import is_excluded_skill_path
...
def _resolve_short_name(name: str, sources, console: Console) -> str:
    ...
    """
    from pm_copilot_engine.tools.skills_hub import unified_search
...
def _existing_categories() -> List[str]:
    ...
    """
    from pm_copilot_engine.tools.skills_hub import SKILLS_DIR
    out: List[str] = []
    try:
...
def do_search(query: str, source: str = "all", limit: int = 10,
    ...
    """
    from pm_copilot_engine.tools.skills_hub import GitHubAuth, create_source_router, unified_search
...
def do_browse(page: int = 1, page_size: int = 20, source: str = "all",
    ...
    """
    from pm_copilot_engine.tools.skills_hub import (
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    from pm_copilot_engine.tools.skills_guard import scan_skill, should_allow_install, format_scan_report
    ...
    try:
        ...
        from pm_copilot_engine.tools.skills_hub import append_audit_log
    ...
    try:
        from pm_copilot_engine.tools.blueprints import BlueprintError, blueprint_spec_for_installed, register_blueprint_suggestion
...
def do_inspect(identifier: str, console: Optional[Console] = None) -> None:
    ...
    from pm_copilot_engine.tools.skills_hub import GitHubAuth, create_source_router
...
def do_list(source_filter: str = "all",
    ...
    """
    from pm_copilot_engine.tools.skills_hub import HubLockFile, ensure_hub_dirs
    from pm_copilot_engine.tools.skills_sync import _read_manifest
    from pm_copilot_engine.tools.skills_tool import _find_all_skills
    from pm_copilot_engine.agent.skill_utils import get_disabled_skill_names
...
def do_check(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from pm_copilot_engine.tools.skills_hub import check_for_skill_updates
...
def do_update(name: Optional[str] = None, console: Optional[Console] = None) -> None:
    ...
    from pm_copilot_engine.tools.skills_hub import HubLockFile, check_for_skill_updates
...
def do_audit(name: Optional[str] = None, console: Optional[Console] = None,
    ...
    are unchanged).
    """
    from pm_copilot_engine.tools.skills_hub import HubLockFile, SKILLS_DIR
    from pm_copilot_engine.tools.skills_guard import scan_skill, format_scan_report
    ...
    if deep:
        from pm_copilot_engine.tools.skills_ast_audit import ast_scan_path, format_ast_report
...
def do_uninstall(name: str, console: Optional[Console] = None,
    ...
    from pm_copilot_engine.tools.skills_hub import uninstall_skill
...
def do_reset(name: str, restore: bool = False,
    ...
    from pm_copilot_engine.tools.skills_sync import reset_bundled_skill
...
def do_opt_out(remove: bool = False,
    ...
    never touched.
    """
    from pm_copilot_engine.tools.skills_sync import (
...
def do_opt_in(sync: bool = False,
    ...
    """
    from pm_copilot_engine.tools.skills_sync import set_bundled_skills_opt_out, sync_skills
...
def do_repair_official(name: str, restore: bool = False,
    ...
    from pm_copilot_engine.tools.skills_sync import restore_official_optional_skill
...
def do_tap(action: str, repo: str = "", console: Optional[Console] = None) -> None:
    ...
    from pm_copilot_engine.tools.skills_hub import TapsManager
...
def do_publish(skill_path: str, target: str = "github", repo: str = "",
    ...
    from pm_copilot_engine.tools.skills_hub import GitHubAuth, SKILLS_DIR
    from pm_copilot_engine.tools.skills_guard import scan_skill, format_scan_report
...
def do_snapshot_export(output_path: str, console: Optional[Console] = None) -> None:
    ...
    from pm_copilot_engine.tools.skills_hub import HubLockFile, TapsManager
