...
def _apply_capabilities(rows: list[dict]) -> None:
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.models import model_supports_fast_mode
...
def _append_unconfigured_rows(rows: list[dict], ctx: ConfigContext) -> list[dict]:
    ...
    from pm_copilot_engine._internal.hermes_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _reorder_canonical(rows: list[dict]) -> list[dict]:
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.models import CANONICAL_PROVIDERS
