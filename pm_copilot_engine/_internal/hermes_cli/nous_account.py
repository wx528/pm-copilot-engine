...
def _fresh_account_info(
    *,
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.auth import get_provider_auth_state, resolve_nous_access_token
...
def _info_from_valid_jwt(
    ...
    *,
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.auth import _decode_jwt_claims
    except Exception:
        return None
