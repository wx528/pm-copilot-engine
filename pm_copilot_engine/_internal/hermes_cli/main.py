...
try:
    import pm_copilot_engine.hermes_bootstrap  # noqa: F401
...
def _print_fast_version_info() -> None:
    from pm_copilot_engine._internal.hermes_cli import __release_date__, __version__
...
from pm_copilot_engine._internal.hermes_cli.subcommands._shared import add_accept_hooks_flag as _add_accept_hooks_flag
from pm_copilot_engine._internal.hermes_cli.subcommands.cron import build_cron_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.gateway import build_gateway_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.profile import build_profile_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.model import build_model_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.setup import build_setup_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.postinstall import build_postinstall_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.whatsapp import build_whatsapp_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.slack import build_slack_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.login import build_login_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.logout import build_logout_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.auth import build_auth_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.status import build_status_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.webhook import build_webhook_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.hooks import build_hooks_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.doctor import build_doctor_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.security import build_security_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.dump import build_dump_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.debug import build_debug_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.backup import build_backup_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.import_cmd import build_import_cmd_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.config import build_config_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.version import build_version_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.update import build_update_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.uninstall import build_uninstall_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.dashboard import build_dashboard_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.gui import build_gui_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.logs import build_logs_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.prompt_size import build_prompt_size_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.memory import build_memory_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.acp import build_acp_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.tools import build_tools_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.insights import build_insights_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.skills import build_skills_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.pairing import build_pairing_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.plugins import build_plugins_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.mcp import build_mcp_parser
from pm_copilot_engine._internal.hermes_cli.subcommands.claw import build_claw_parser
...
def _apply_profile_override() -> None:
    ...
    if profile_name is None:
        try:
            from pm_copilot_engine.hermes_constants import get_default_hermes_root
...
from pm_copilot_engine._internal.hermes_cli.config import get_hermes_home
from pm_copilot_engine._internal.hermes_cli.env_loader import load_hermes_dotenv
...
try:
    from pm_copilot_engine.hermes_logging import setup_logging as _setup_logging
...
if _FORCE_IPV4_EARLY:
    try:
        from pm_copilot_engine.hermes_constants import apply_ipv4_preference as _apply_ipv4
...
from pm_copilot_engine._internal.hermes_cli import __version__, __release_date__
...
from pm_copilot_engine._internal.hermes_cli.model_setup_flows import (
...
def _sync_bundled_skills_for_startup() -> bool:
    ...
    from pm_copilot_engine.tools.skills_sync import sync_skills
...
def _has_any_provider_configured() -> bool:
    ...
    from pm_copilot_engine._internal.hermes_cli.config import get_env_path, get_hermes_home, load_config
    from pm_copilot_engine._internal.hermes_cli.auth import get_auth_status

    # Determine whether Hermes itself has been explicitly configured (model
    # in config that isn't the hardcoded default). Used below to gate external
    # tool credentials (Claude Code, Codex CLI) that shouldn't silently skip
    # the setup wizard on a fresh install.
    from pm_copilot_engine._internal.hermes_cli.config import DEFAULT_CONFIG
    ...
    from pm_copilot_engine._internal.hermes_cli.auth import PROVIDER_REGISTRY
    ...
    if _has_hermes_config:
        try:
            from pm_copilot_engine.agent.anthropic_adapter import (
...
def _resolve_last_session(source: str = "cli") -> Optional[str]:
    ...
    db = None
    try:
        from pm_copilot_engine.hermes_state import SessionDB
...
def _make_tui_argv(tui_dir: Path, tui_dev: bool) -> tuple[list[str], Path]:
    ...
    def _node_bin(bin: str) -> str:
        ...
        if not path and bin == "node":
            try:
                from pm_copilot_engine._internal.hermes_cli.dep_ensure import ensure_dependency
...
def _normalize_tui_toolsets(toolsets: object) -> list[str]:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.oneshot import _normalize_toolsets
...
def _launch_tui(
    ...
    env = os.environ.copy()
    try:
        from pm_copilot_engine._internal.hermes_cli.config import apply_terminal_config_to_env
    ...
    if code == 42:
        from pm_copilot_engine._internal.hermes_cli.relaunch import relaunch
...
def _pin_kanban_board_env() -> None:
    ...
    if os.environ.get("HERMES_KANBAN_BOARD"):
        return
    try:
        from pm_copilot_engine._internal.hermes_cli.kanban_db import get_current_board
...
def _resolve_use_tui(args) -> bool:
    ...
    if getattr(args, "tui", False) or os.environ.get("HERMES_TUI") == "1":
        return True
    try:
        from pm_copilot_engine._internal.hermes_cli.config import load_config
...
def cmd_chat(args):
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.xai_retirement import (
            MIGRATION_GUIDE_URL,
            RETIREMENT_DATE,
            find_retired_xai_refs,
            format_issue,
        )
        from pm_copilot_engine._internal.hermes_cli.config import load_config as _load_config_for_xai_check
    ...
    if not _has_any_provider_configured():
        ...
        from pm_copilot_engine._internal.hermes_cli.setup import (
    ...
    if _termux_should_prefetch_update_check():
        try:
            from pm_copilot_engine._internal.hermes_cli.banner import prefetch_update_check
...
def cmd_gateway(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.gateway import gateway_command
...
def cmd_proxy(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.proxy.cli import cmd_proxy as _cmd_proxy
...
def cmd_whatsapp(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.config import get_env_value, save_env_value
...
def cmd_whatsapp_cloud(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.setup_whatsapp_cloud import run_whatsapp_cloud_setup
...
def cmd_setup(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.setup import run_setup_wizard
...
def cmd_postinstall(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.config import stamp_install_method
    from pm_copilot_engine._internal.hermes_cli.dep_ensure import ensure_dependency
...
def cmd_model(args):
    ...
    if getattr(args, "refresh", False):
        try:
            from pm_copilot_engine._internal.hermes_cli.models import clear_provider_models_cache
...
def _is_profile_api_key_provider(provider_id: str) -> bool:
    ...
    """
    try:
        from pm_copilot_engine.providers import get_provider_profile
...
def select_provider_and_model(args=None):
    ...
    from pm_copilot_engine._internal.hermes_cli.config import (
        get_compatible_custom_providers,
        load_config,
        get_env_value,
    )
    from pm_copilot_engine._internal.hermes_cli.providers import resolve_provider_full
    ...
    def _named_custom_provider_map(cfg) -> dict[str, dict[str, str]]:
        from pm_copilot_engine._internal.hermes_cli.config import read_raw_config
    ...
    from pm_copilot_engine._internal.hermes_cli.models import (
        CANONICAL_PROVIDERS,
        _PROVIDER_LABELS,
        group_providers,
...
def _clear_stale_openai_base_url():
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.config import get_env_value, save_env_value, load_config
...
def _all_aux_tasks() -> list[tuple[str, str, str]]:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.plugins import get_plugin_auxiliary_tasks
...
def _save_aux_choice(
    ...
    *,
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.config import load_config, save_config
...
def _aux_select_for_task(task: str) -> None:
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.config import load_config
    from pm_copilot_engine._internal.hermes_cli.model_switch import list_authenticated_providers
...
def _aux_flow_provider_model(
    ...
    from pm_copilot_engine._internal.hermes_cli.auth import _prompt_model_selection
    from pm_copilot_engine._internal.hermes_cli.models import get_pricing_for_provider
...
def _aux_flow_custom_endpoint(task: str, task_cfg: dict) -> None:
    ...
    from pm_copilot_engine._internal.hermes_cli.secret_prompt import masked_secret_prompt
...
def _prompt_provider_choice(choices, *, default=0, title="Select provider:"):
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.setup import _curses_prompt_choice
...
def _prompt_custom_api_mode_selection(base_url: str, current_api_mode: str = "") -> Optional[str]:
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.runtime_provider import _detect_api_mode_for_url
...
def _remove_custom_provider(config):
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.curses_ui import curses_radiolist
...
def __getattr__(name):
    ...
    if name in _LAZY_MODEL_EXPORTS:
        from pm_copilot_engine._internal.hermes_cli.models import _PROVIDER_MODELS
...
def _prompt_api_key(pconfig, existing_key: str, provider_id: str = "") -> tuple:
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.auth import LMSTUDIO_NOAUTH_PLACEHOLDER
    from pm_copilot_engine._internal.hermes_cli.config import save_env_value
    from pm_copilot_engine._internal.hermes_cli.secret_prompt import masked_secret_prompt
    ...
    from pm_copilot_engine._internal.hermes_cli.env_loader import format_secret_source_suffix
...
def _run_anthropic_oauth_flow(save_env_value):
    ...
    def _activate_claude_code_credentials_if_available() -> bool:
        ...
        if creds and (
            ...
            from pm_copilot_engine.hermes_constants import display_hermes_home as _dhh_fn
...
def cmd_login(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.auth import login_command
...
def cmd_logout(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.auth import logout_command
...
def cmd_auth(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.auth_commands import auth_command
...
def cmd_status(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.status import show_status
...
def cmd_cron(args):
    """Cron job management."""
    from pm_copilot_engine._internal.hermes_cli.cron import cron_command
...
def cmd_webhook(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.webhook import webhook_command
...
def cmd_slack(args):
    ...
    if sub == "manifest":
        from pm_copilot_engine._internal.hermes_cli.slack_cli import slack_manifest_command
...
def cmd_kanban(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.kanban import kanban_command
...
def cmd_hooks(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.hooks import hooks_command
...
def cmd_doctor(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.doctor import run_doctor
...
def cmd_security(args):
    ...
    if sub in ("audit", None):
        from pm_copilot_engine._internal.hermes_cli.security_audit import cmd_security_audit
...
def cmd_dump(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.dump import run_dump
...
def cmd_debug(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.debug import run_debug
...
def cmd_config(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.config import config_command
...
def cmd_backup(args):
    ...
    if getattr(args, "quick", False):
        from pm_copilot_engine._internal.hermes_cli.backup import run_quick_backup

        run_quick_backup(args)
    else:
        from pm_copilot_engine._internal.hermes_cli.backup import run_backup
...
def cmd_import(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.backup import run_import

    run_import(args)


def _print_version_info(*, check_updates: bool = True) -> None:
    from pm_copilot_engine._internal.hermes_cli.banner import format_banner_version_label
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.banner import check_for_updates
        from pm_copilot_engine._internal.hermes_cli.config import recommended_update_command
...
def cmd_uninstall(args):
    ...
    if getattr(args, "gui_summary", False):
        from pm_copilot_engine._internal.hermes_cli.gui_uninstall import gui_install_summary
    ...
    if getattr(args, "gui", False):
        ...
        from pm_copilot_engine._internal.hermes_cli.uninstall import run_gui_uninstall
    ...
    from pm_copilot_engine._internal.hermes_cli.uninstall import run_uninstall
...
def cmd_gui(args: argparse.Namespace):
    ...
    try:
        from pm_copilot_engine.hermes_logging import setup_logging as _setup_logging_gui
...
def _print_curator_first_run_notice() -> None:
    ...
    """
    try:
        from pm_copilot_engine.agent import curator
    except Exception:
        return
    try:
...
def _update_via_zip(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.managed_uv import ensure_uv, update_managed_uv
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.model_catalog import seed_cache_from_checkout
...
def _recover_from_interrupted_install() -> None:
    ...
    try:
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.managed_uv import ensure_uv
...
def _refresh_active_lazy_features() -> None:
    ...
    """
    try:
        from pm_copilot_engine.tools import lazy_deps
    except Exception as exc:
...
def _install_psutil_android_compat(
    ...
    *,
    ...
    from pm_copilot_engine._internal.hermes_cli.psutil_android import PSUTIL_URL, prepare_patched_psutil_sdist
...
def _ensure_uv_for_termux(pip_cmd: list[str]) -> str | None:
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.managed_uv import resolve_uv
...
def _install_hangup_protection(gateway_mode: bool = False):
    ...
    **intentionally left alone** — those are legitimate cancellation
    ...
    try:
        ...
        from pm_copilot_engine._internal.hermes_cli.config import get_hermes_home as _get_hermes_home
...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    dropping the flag.
    """
    from pm_copilot_engine._internal.hermes_cli.config import detect_install_method
    ...
    if method == "docker":
        ...
        from pm_copilot_engine._internal.hermes_cli.config import format_docker_update_message
        print(format_docker_update_message())
        sys.exit(1)
    if method == "pip":
        from pm_copilot_engine._internal.hermes_cli.config import recommended_update_command
        from pm_copilot_engine._internal.hermes_cli.banner import check_via_pypi
...
def _run_pre_update_backup(args) -> None:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.backup import create_pre_update_backup
    except Exception as exc:
        print(
    ...
    try:
        from pm_copilot_engine.hermes_constants import get_hermes_home, display_hermes_home
...
def _write_update_planned_stop_marker(profile_path: Path, pid: int) -> bool:
    ...
    try:
        ...
        from pm_copilot_engine.utils import atomic_json_write
...
def _pause_windows_gateways_for_update() -> dict | None:
    ...
    try:
        ...
        from pm_copilot_engine._internal.hermes_cli.gateway import (
...
def _resume_windows_gateways_after_update(token: dict | None) -> None:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.gateway import launch_detached_profile_gateway_restart
    except Exception as exc:
...
def _cmd_update_pip(args):
    ...
    from pm_copilot_engine._internal.hermes_cli import __version__
    from pm_copilot_engine._internal.hermes_cli.config import is_uv_tool_install
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.backup import create_quick_snapshot
        ...
        try:
            import importlib
            import pm_copilot_engine.hermes_constants as _hc
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.profiles import (
                list_profiles,
                seed_profile_skills,
            )
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.profiles import backfill_profile_envs
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.backup import restore_cron_jobs_if_emptied
        ...
        try:
            if sys.platform == "darwin" and shutil.which("cua-driver"):
                from pm_copilot_engine._internal.hermes_cli.tools_config import install_cua_driver
        ...
        try:
            ...
            try:
                from pm_copilot_engine.hermes_constants import (
...
def cmd_profile(args):
    ...
    from pm_copilot_engine.hermes_constants import display_hermes_home
    ...
    if action == "list":
        ...
        from pm_copilot_engine._internal.hermes_cli import profiles as _profiles_mod
        ...
        if name and not text_value and not auto_flag:
            try:
                if _profiles_mod.normalize_profile_name(name) == "default":
                    from pm_copilot_engine.hermes_constants import get_hermes_home as _hh
        ...
        from pm_copilot_engine._internal.hermes_cli import profile_describer as _pd
        ...
        from pm_copilot_engine._internal.hermes_cli.profiles import profile_exists
        ...
        from pm_copilot_engine._internal.hermes_cli.profiles import rename_profile
        ...
        from pm_copilot_engine._internal.hermes_cli.profiles import export_profile
        ...
        from pm_copilot_engine._internal.hermes_cli.profiles import import_profile
        ...
        import tempfile
        from pm_copilot_engine._internal.hermes_cli.profile_distribution import (
            plan_install,
        ...
        from pm_copilot_engine._internal.hermes_cli.profiles import get_profile_dir, normalize_profile_name
        ...
        from pm_copilot_engine._internal.hermes_cli.profile_distribution import describe_distribution, DistributionError
...
def _render_distribution_plan(plan) -> None:
    ...
    from pm_copilot_engine._internal.hermes_cli.profile_distribution import MANIFEST_FILENAME
    mf = plan.manifest
...
def cmd_dashboard(args):
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.profiles import get_active_profile_name
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.plugins import discover_plugins
        discover_plugins()
    except Exception as exc:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.mcp_startup import start_background_mcp_discovery
    ...
    from pm_copilot_engine._internal.hermes_cli.web_server import start_server
...
def cmd_dashboard_register(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.dashboard_register import cmd_dashboard_register as _impl
...
def cmd_completion(args, parser=None):
    ...
    from pm_copilot_engine._internal.hermes_cli.completion import generate_bash, generate_zsh, generate_fish
...
def cmd_prompt_size(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.prompt_size import cmd_prompt_size as _impl
...
def cmd_logs(args):
    ...
    from pm_copilot_engine._internal.hermes_cli.logs import tail_log, list_logs
...
def _prepare_agent_startup(args) -> None:
    ...
    if _run_inline_mcp_discovery:
        try:
            ...
            from pm_copilot_engine.tools.mcp_tool import discover_mcp_tools
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.config import load_config
        from pm_copilot_engine.agent.shell_hooks import register_from_config
...
def _try_termux_fast_cli_launch() -> bool:
    ...
    from pm_copilot_engine._internal.hermes_cli._parser import build_top_level_parser
    ...
    if getattr(args, "oneshot", None):
        ...
        from pm_copilot_engine._internal.hermes_cli.oneshot import run_oneshot
...
def cmd_memory(args):
    ...
    if sub == "off":
        ...
        from pm_copilot_engine._internal.hermes_cli.memory_setup import memory_command
...
def cmd_tools(args):
    ...
    if action in {"list", "disable", "enable"}:
        from pm_copilot_engine._internal.hermes_cli.tools_config import tools_disable_enable_command

        tools_disable_enable_command(args)
    elif action == "post-setup":
        from pm_copilot_engine._internal.hermes_cli.tools_config import run_post_setup_command

        sys.exit(run_post_setup_command(args))
    else:
        _require_tty("tools")
        from pm_copilot_engine._internal.hermes_cli.tools_config import tools_command
...
def cmd_insights(args):
    try:
        from pm_copilot_engine.hermes_state import SessionDB
        from pm_copilot_engine.agent.insights import InsightsEngine
...
def cmd_skills(args):
    ...
    if getattr(args, "skills_action", None) == "config":
        ...
        from pm_copilot_engine._internal.hermes_cli.skills_config import skills_command as skills_config_command

        skills_config_command(args)
    else:
        from pm_copilot_engine._internal.hermes_cli.skills_hub import skills_command

        skills_command(args)


def cmd_pairing(args):
    from pm_copilot_engine._internal.hermes_cli.pairing import pairing_command

    pairing_command(args)


def cmd_plugins(args):
    from pm_copilot_engine._internal.hermes_cli.plugins_cmd import plugins_command

    plugins_command(args)


def cmd_mcp(args):
    from pm_copilot_engine._internal.hermes_cli.mcp_config import mcp_command

    mcp_command(args)


def cmd_claw(args):
    from pm_copilot_engine._internal.hermes_cli.claw import claw_command
...
def main():
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.stdio import configure_windows_stdio
    ...
    # =========================================================================
    from pm_copilot_engine._internal.hermes_cli.fallback_cmd import cmd_fallback
    ...
    from pm_copilot_engine._internal.hermes_cli import secrets_cli as _secrets_cli
    ...
    # migrate command
    # =========================================================================
    from pm_copilot_engine._internal.hermes_cli.migrate import cmd_migrate, cmd_migrate_xai
    ...
    # =========================================================================
    try:
        from pm_copilot_engine.agent.lsp.cli import register_subparser as _lsp_register
    ...
    # =========================================================================
    from pm_copilot_engine._internal.hermes_cli.send_cmd import register_send_subparser
    ...
    # =========================================================================
    from pm_copilot_engine._internal.hermes_cli.portal_cli import add_parser as _add_portal_parser
    _add_portal_parser(subparsers)

    # =========================================================================
    # kanban command — multi-profile collaboration board
    # =========================================================================
    from pm_copilot_engine._internal.hermes_cli.kanban import build_parser as _build_kanban_parser
    ...
    from pm_copilot_engine._internal.hermes_cli.checkpoints import register_cli as _register_checkpoints_cli
    ...
    from pm_copilot_engine._internal.hermes_cli.bundles import register_cli as _bundles_register, bundles_command
    ...
    if _plugin_cli_discovery_needed():
        try:
            ...
            from pm_copilot_engine._internal.hermes_cli.plugins import discover_plugins, get_plugin_manager
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.curator import register_cli as _register_curator_cli
    ...
    def cmd_sessions(args):
        ...
        if action == "repair":
            from pm_copilot_engine.hermes_state import (
                DEFAULT_DB_PATH,
                _db_opens_cleanly,
    ...
    from pm_copilot_engine._internal.hermes_cli.config import get_container_exec_info
