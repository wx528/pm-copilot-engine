...
from pm_copilot_engine._internal.hermes_cli.dashboard_auth.base import (
    InvalidCodeError,
...
from pm_copilot_engine._internal.hermes_cli.dashboard_auth.login_page import render_login_html
...
def _redirect_uri(request: Request) -> str:
    ...
    from pm_copilot_engine._internal.hermes_cli.dashboard_auth.prefix import (
        prefix_from_request,
        resolve_public_url,
    )
...
async def api_auth_ws_ticket(request: Request):
    ...
    from pm_copilot_engine._internal.hermes_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
