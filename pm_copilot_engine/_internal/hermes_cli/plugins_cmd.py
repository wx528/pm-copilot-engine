...
def _prompt_plugin_env_vars(manifest: dict, console) -> None:
    ...
    from pm_copilot_engine._internal.hermes_cli.config import get_env_value, save_env_value  # noqa: F811
...
def _discover_context_engines() -> list[tuple[str, str]]:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.plugins import discover_plugins, get_plugin_context_engine
        discover_plugins()
...
def _run_composite_ui(curses, plugin_names, plugin_labels, plugin_selected,
    ...
    from pm_copilot_engine._internal.hermes_cli.curses_ui import flush_stdin
