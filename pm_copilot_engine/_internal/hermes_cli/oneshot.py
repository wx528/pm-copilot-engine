...
from pm_copilot_engine._internal.hermes_cli.fallback_config import get_fallback_chain
...
def _validate_explicit_toolsets(toolsets: object = None) -> tuple[list[str] | None, str | None]:
    ...
    try:
        from pm_copilot_engine.toolsets import validate_toolset
    ...
    if unresolved:
        try:
            ...
            from pm_copilot_engine._internal.hermes_cli.tools_config import _parse_enabled_flag
...
def _run_agent(
    ...
    from pm_copilot_engine._internal.hermes_cli.models import detect_provider_for_model
    ...
    if effective_provider is None and (model or env_model):
        ...
        if explicit_model:
            ...
            try:
                from pm_copilot_engine._internal.hermes_cli import model_switch as _ms
