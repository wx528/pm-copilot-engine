...
def check_codex_binary_ok() -> tuple[bool, Optional[str]]:
    ...
    try:
        from pm_copilot_engine.agent.transports.codex_app_server import check_codex_binary
...
def apply(
    ...
    *,
    ...
    if new_value == "codex_app_server":
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.codex_runtime_plugin_migration import migrate
