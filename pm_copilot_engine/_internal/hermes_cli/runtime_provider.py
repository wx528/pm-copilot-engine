...
from pm_copilot_engine._internal.hermes_cli import auth as auth_mod
from pm_copilot_engine.agent.credential_pool import CredentialPool, PooledCredential, get_custom_provider_pool_key, load_pool
...
def _config_base_url_trustworthy_for_bare_custom(cfg_base_url: str, cfg_provider: str) -> bool:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.auth import resolve_provider as _resolve_provider
...
def _copilot_runtime_api_mode(model_cfg: Dict[str, Any], api_key: str) -> str:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.models import copilot_model_api_mode
    ...
    *,
    ...
    if provider == "openai-codex":
        ...
        if effective_model and api_mode != "anthropic_messages":
            try:
                from pm_copilot_engine._internal.hermes_cli.models import azure_foundry_model_api_mode
        ...
        if provider in {"opencode-zen", "opencode-go"}:
            ...
            # Refs #16878.
            from pm_copilot_engine._internal.hermes_cli.models import opencode_model_api_mode
...
def _resolve_explicit_runtime(
    *,
    ...
    if provider == "anthropic":
        ...
        api_key = explicit_api_key
        if not api_key:
            from pm_copilot_engine.agent.anthropic_adapter import resolve_anthropic_token
    ...
    *,
    ...
    if provider == "minimax-oauth":
        ...
        if pconfig and pconfig.auth_type == "oauth_minimax":
            from pm_copilot_engine._internal.hermes_cli.auth import resolve_minimax_oauth_runtime_credentials
