...
from pm_copilot_engine._internal.hermes_cli import kanban_db as kb
from pm_copilot_engine._internal.hermes_cli import kanban_swarm as ks
from pm_copilot_engine._internal.hermes_cli.profiles import get_active_profile_name, get_profile_dir, seed_profile_skills
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from pm_copilot_engine._internal.hermes_cli import kanban_specify as spec
...
def _cmd_decompose(args: argparse.Namespace) -> int:
    ...
    from pm_copilot_engine._internal.hermes_cli import kanban_decompose as decomp
