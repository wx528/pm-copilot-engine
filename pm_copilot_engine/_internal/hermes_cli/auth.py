...
from pm_copilot_engine._internal.hermes_cli.config import get_hermes_home, get_config_path, read_raw_config
from pm_copilot_engine.hermes_constants import OPENROUTER_BASE_URL, secure_parent_dir
from pm_copilot_engine.agent.credential_persistence import sanitize_borrowed_credential_payload
from pm_copilot_engine.utils import atomic_replace, atomic_yaml_write, is_truthy_value
...
try:
    from pm_copilot_engine.providers import list_providers as _list_providers_for_registry
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def resolve_provider(
    ...
    *,
    ...
    try:
        from pm_copilot_engine.providers import list_providers as _lp
        for _pp in _lp():
            for _alias in _pp.aliases:
    ...
    try:
        from pm_copilot_engine.agent.credential_pool import load_pool as _load_pool
...
def resolve_gemini_oauth_runtime_credentials(
    *,
    ...
    try:
        from pm_copilot_engine.agent.google_oauth import (
            GoogleOAuthError,
            _credentials_path,
...
def get_gemini_oauth_auth_status() -> Dict[str, Any]:
    ...
    try:
        from pm_copilot_engine.agent.google_oauth import _credentials_path, load_credentials
    except ImportError:
...
def _get_azure_foundry_auth_status() -> Dict[str, Any]:
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.config import load_config, get_env_value
        cfg = load_config()
    except Exception:
        cfg = {}
...
def _prompt_model_selection(
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.models import _format_price_per_mtok
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.config import save_config, load_config
