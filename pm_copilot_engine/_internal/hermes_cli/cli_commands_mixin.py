...
from pm_copilot_engine.hermes_constants import display_hermes_home, is_termux as _is_termux_environment
from pm_copilot_engine._internal.hermes_cli.browser_connect import (
...
class CLICommandsMixin:
    ...
    def _handle_rollback_command(self, command: str):
        ...
        """
        from pm_copilot_engine.tools.checkpoint_manager import format_checkpoint_list
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from pm_copilot_engine._internal.hermes_cli.backup import (
    ...
    def _handle_agents_command(self):
        ...
        from pm_copilot_engine.tools.process_registry import format_uptime_short, process_registry
    ...
    def _handle_paste_command(self):
        ...
        from pm_copilot_engine._internal.hermes_cli.clipboard import has_clipboard_image
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        """
        from cli import _cprint
        from pm_copilot_engine.hermes_state import format_session_db_unavailable
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from pm_copilot_engine._internal.hermes_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_gquota_command(self, cmd_original: str) -> None:
        ...
        try:
            from pm_copilot_engine.agent.google_oauth import get_valid_access_token, GoogleOAuthError, load_credentials
            from pm_copilot_engine.agent.google_code_assist import retrieve_user_quota, CodeAssistError
    ...
    def _handle_cron_command(self, cmd: str):
        ...
        import shlex
        from pm_copilot_engine.tools.cronjob_tools import cronjob as cronjob_tool
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from pm_copilot_engine._internal.hermes_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from pm_copilot_engine._internal.hermes_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from pm_copilot_engine._internal.hermes_cli.write_approval_commands import handle_pending_subcommand
            from pm_copilot_engine.tools import write_approval as wa
            ...
            if out is not None:
                print(out)
                return
        from pm_copilot_engine._internal.hermes_cli.skills_hub import handle_skills_slash
    ...
    def _handle_background_command(self, cmd: str):
        ...
        def run_background():
            ...
            try:
                ...
                if response:
                    try:
                        from pm_copilot_engine._internal.hermes_cli.skin_engine import get_active_skin
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        try:
            from pm_copilot_engine.agent.skill_bundles import list_bundles, _bundles_dir
        except Exception as exc:
    ...
    def _handle_browser_command(self, cmd: str):
        ...
        if sub.startswith("connect"):
            ...
            try:
                from pm_copilot_engine.tools.browser_tool import cleanup_all_browsers
            ...
            try:
                from pm_copilot_engine.tools.browser_tool import _ensure_cdp_supervisor  # type: ignore[import-not-found]
            ...
            if current:
                ...
                try:
                    from pm_copilot_engine.tools.browser_tool import cleanup_all_browsers, _stop_cdp_supervisor
            ...
            if current:
                ...
                try:
                    from pm_copilot_engine.tools.browser_tool import _get_cloud_provider
                ...
                if provider is not None:
                    ...
                    try:
                        from pm_copilot_engine.tools.browser_tool import _get_browser_engine
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_footer_command(self, cmd_original: str) -> None:
        ...
        from pm_copilot_engine._internal.hermes_cli.config import load_config
        from pm_copilot_engine._internal.hermes_cli.colors import Colors as _Colors
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.models import _is_anthropic_fast_model
    ...
    def _handle_debug_command(self):
        ...
        from pm_copilot_engine._internal.hermes_cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        ...
        when cancelled.
        """
        from pm_copilot_engine._internal.hermes_cli.config import is_managed, format_managed_message
