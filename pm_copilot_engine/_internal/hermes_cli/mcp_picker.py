...
from pm_copilot_engine._internal.hermes_cli.cli_output import prompt_yes_no
from pm_copilot_engine._internal.hermes_cli.curses_ui import curses_single_select
from pm_copilot_engine._internal.hermes_cli.mcp_catalog import (
    CatalogEntry,
    CatalogError,
    catalog_diagnostics,
    install_entry,
...
def _configure_tools(name: str) -> None:
    ...
    """
    import argparse
    from pm_copilot_engine._internal.hermes_cli.mcp_config import cmd_mcp_configure
...
def install_by_name(identifier: str) -> int:
    ...
    exit codes).
    """
    from pm_copilot_engine._internal.hermes_cli.mcp_catalog import get_entry
