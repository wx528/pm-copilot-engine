...
def uninstall_gateway_service():
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.gateway import kill_gateway_processes, find_gateway_pids
    ...
    # 3. macOS: uninstall launchd plist
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.gateway import get_launchd_plist_path
...
def run_gui_uninstall(args):
    ...
    """
    from pm_copilot_engine._internal.hermes_cli.gui_uninstall import (
        agent_is_installed,
        gui_install_summary,
        uninstall_gui,
    )
...
def _perform_uninstall(
    *,
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.gui_uninstall import uninstall_gui
