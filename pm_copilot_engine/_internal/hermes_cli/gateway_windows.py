...
def _current_profile_cli_args() -> list[str]:
    ...
    from pm_copilot_engine._internal.hermes_cli.gateway import _profile_arg
...
def get_task_name() -> str:
    ...
    from pm_copilot_engine._internal.hermes_cli.gateway import _profile_suffix
...
def _prompt_install_choices(
    ...
    from pm_copilot_engine._internal.hermes_cli.setup import prompt_yes_no
...
def _install_startup_fallback(script_path: Path, start_now: bool, detail: str) -> None:
    ...
    from pm_copilot_engine._internal.hermes_cli.gateway import find_gateway_pids, _profile_arg
...
def stop() -> None:
    ...
    """
    _assert_windows()
    from pm_copilot_engine._internal.hermes_cli.gateway import kill_gateway_processes, _get_restart_drain_timeout
    from gateway.status import get_running_pid
