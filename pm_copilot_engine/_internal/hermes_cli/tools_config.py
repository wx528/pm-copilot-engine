...
from pm_copilot_engine._internal.hermes_cli.nous_subscription import (
    apply_nous_managed_defaults,
    get_nous_subscription_features,
)
from pm_copilot_engine._internal.hermes_cli.nous_account import format_nous_portal_entitlement_message
from pm_copilot_engine.tools.tool_backend_helpers import fal_key_is_configured
from pm_copilot_engine.utils import base_url_hostname, is_truthy_value
...
from pm_copilot_engine._internal.hermes_cli.cli_output import (  # noqa: E402 — late import block
...
def _xai_credentials_present() -> bool:
    ...
    """
    try:
        from pm_copilot_engine._internal.hermes_cli.auth import _read_xai_oauth_tokens
        ...
        pass
    try:
        from pm_copilot_engine.tools.xai_http import get_env_value as _xai_get_env_value
...
def _get_effective_configurable_toolsets():
    ...
    try:
        from pm_copilot_engine._internal.hermes_cli.plugins import discover_plugins, get_plugin_toolsets
...
from pm_copilot_engine._internal.hermes_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
    ...
    if post_setup_key in {"agent_browser", "browserbase"}:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                import pm_copilot_engine.tools.browser_tool as _bt
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.auth import login_spotify_command
        except Exception as exc:
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.plugins_cmd import _get_enabled_set, _save_enabled_set
...
def _get_platform_tools(
    ...
    *,
    ...
    from pm_copilot_engine.toolsets import resolve_toolset, TOOLSETS
...
def _toolset_has_keys(
    ...
    *,
    ...
    if ts_key == "vision":
        try:
            from pm_copilot_engine.agent.auxiliary_client import resolve_vision_provider_client
...
def _estimate_tool_tokens() -> Dict[str, int]:
    ...
    try:
        ...
        import pm_copilot_engine.model_tools  # noqa: F401
...
def _plugin_video_gen_providers() -> list[dict]:
    ...
    """
    try:
        from pm_copilot_engine.agent.video_gen_registry import list_providers
        from pm_copilot_engine._internal.hermes_cli.plugins import _ensure_plugins_discovered
...
def _plugin_web_search_providers() -> list[dict]:
    ...
    """
    try:
        from pm_copilot_engine.agent.web_search_registry import list_providers as _list_web_providers
        from pm_copilot_engine._internal.hermes_cli.plugins import _ensure_plugins_discovered
...
def _plugin_browser_providers() -> list[dict]:
    ...
    """
    try:
        from pm_copilot_engine.agent.browser_registry import list_providers as _list_browser_providers
        from pm_copilot_engine._internal.hermes_cli.plugins import _ensure_plugins_discovered
...
def _plugin_tts_providers() -> list[dict]:
    ...
    """
    try:
        from pm_copilot_engine.agent.tts_registry import _BUILTIN_NAMES, list_providers
        from pm_copilot_engine._internal.hermes_cli.plugins import _ensure_plugins_discovered
...
def _toolset_needs_configuration_prompt(
    ...
    *,
    ...
    if ts_key == "web":
        ...
        from pm_copilot_engine.tools.web_tools import check_web_api_key
...
def _fal_model_catalog():
    ...
    from pm_copilot_engine.tools.image_generation_tool import FAL_MODELS, DEFAULT_MODEL
...
def _plugin_image_gen_catalog(plugin_name: str):
    ...
    """
    try:
        from pm_copilot_engine.agent.image_gen_registry import get_provider
        from pm_copilot_engine._internal.hermes_cli.plugins import _ensure_plugins_discovered
...
def _plugin_video_gen_catalog(plugin_name: str):
    ...
    """
    try:
        from pm_copilot_engine.agent.video_gen_registry import get_provider
        from pm_copilot_engine._internal.hermes_cli.plugins import _ensure_plugins_discovered
...
def _configure_mcp_tools_interactive(config: dict):
    ...
    try:
        from pm_copilot_engine.tools.mcp_tool import probe_mcp_server_tools
