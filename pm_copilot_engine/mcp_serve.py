...
def _get_sessions_dir() -> Path:
    ...
    try:
        ...
        return Path(os.environ.get("PM_COPILOT_HOME", Path.home() / ".hermes")) / "sessions"
...
def _load_channel_directory() -> dict:
    ...
    try:
        ...
        directory_file = Path(
            os.environ.get("PM_COPILOT_HOME", Path.home() / ".hermes")
...
class EventBridge:
    ...
    def _poll_once(self, db):
        ...
        try:
            ...
            db_file = Path(os.environ.get("PM_COPILOT_HOME", Path.home() / ".hermes")) / "state.db"
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    ...
    def messages_send(
        ...
        try:
            from pm_copilot_engine.tools.send_message_tool import send_message_tool
