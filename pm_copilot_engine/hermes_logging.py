...
from pm_copilot_engine.hermes_constants import get_config_path, get_hermes_home
...
def setup_logging(
    ...
    *force* is ``True``.
    ...
    from pm_copilot_engine.agent.redact import RedactingFormatter
...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    def __init__(self, *args, **kwargs):
        from pm_copilot_engine._internal.hermes_cli.config import is_managed
