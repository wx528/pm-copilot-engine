...
from pm_copilot_engine._internal.hermes_cli.profiles import _get_default_hermes_home
...
def get_honcho_client(config: HonchoClientConfig | None = None) -> Honcho:
    ...
    def _build() -> "Honcho":
        ...
        try:
            from pm_copilot_engine.tools.lazy_deps import FeatureUnavailable, ensure as _lazy_ensure
