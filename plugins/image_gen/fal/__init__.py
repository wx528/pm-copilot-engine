...
that module via call-time indirection (``import pm_copilot_engine.tools.image_generation_tool as _it``)
so:
...
class FalImageGenProvider(ImageGenProvider):
    ...
    def is_available(self) -> bool:
        ...
        # there.
        import pm_copilot_engine.tools.image_generation_tool as _it
        try:
