...
from pm_copilot_engine.agent.video_gen_provider import (
    VideoGenProvider,
    error_response,
    success_response,
)
...
def _resolve_managed_fal_video_gateway():
    ...
    from pm_copilot_engine.tools.tool_backend_helpers import fal_key_is_configured, prefers_gateway
...
def _get_managed_fal_video_client(managed_gateway):
    ...
    from pm_copilot_engine.tools.fal_common import _ManagedFalSyncClient
...
def _submit_fal_video_request(endpoint: str, arguments: Dict[str, Any]):
    ...
    try:
        ...
        from pm_copilot_engine.tools.fal_common import _extract_http_status
