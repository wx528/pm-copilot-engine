...
class TeamsSummaryWriter:
    ...
    def _build_graph_client(self, config: dict[str, Any]) -> Any:
        ...
        from pm_copilot_engine.tools.microsoft_graph_auth import MicrosoftGraphTokenProvider
        from pm_copilot_engine.tools.microsoft_graph_client import MicrosoftGraphClient
...
class TeamsAdapter(BasePlatformAdapter):
    ...
    async def _on_card_action(
        ...
        from pm_copilot_engine.tools.approval import resolve_gateway_approval, has_blocking_approval
