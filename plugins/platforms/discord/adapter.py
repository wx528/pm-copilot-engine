...
from pm_copilot_engine.tools.url_safety import is_safe_url
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def _process_voice_input(self, guild_id: int, user_id: int, pcm_data: bytes):
        ...
        from pm_copilot_engine.tools.voice_mode import is_whisper_hallucination
    ...
    def _register_slash_commands(self) -> None:
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from pm_copilot_engine._internal.hermes_cli.commands import _iter_plugin_command_entries
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from pm_copilot_engine._internal.hermes_cli.commands import discord_skill_commands_by_category
    ...
    async def send_model_picker(
        ...
        try:
            ...
            try:
                from pm_copilot_engine._internal.hermes_cli.providers import get_label
...
def _define_discord_view_classes() -> None:
    ...
    class ExecApprovalView(discord.ui.View):
        ...
        async def _resolve(
            ...
            try:
                from pm_copilot_engine.tools.approval import resolve_gateway_approval
    ...
    class SlashConfirmView(discord.ui.View):
        ...
        async def _resolve(
            ...
            try:
                from pm_copilot_engine.tools import slash_confirm as _slash_confirm_mod
    ...
    class ClarifyChoiceView(discord.ui.View):
        ...
        async def _resolve_choice(
            ...
            try:
                from pm_copilot_engine.tools.clarify_gateway import _entries as _clarify_entries  # type: ignore
            ...
            try:
                from pm_copilot_engine.tools.clarify_gateway import resolve_gateway_clarify
        ...
        async def _on_other(self, interaction: "discord.Interaction") -> None:
            ...
            try:
                from pm_copilot_engine.tools.clarify_gateway import mark_awaiting_text
...
def interactive_setup() -> None:
    ...
    from pm_copilot_engine._internal.hermes_cli.cli_output import (
        prompt,
        prompt_yes_no,
        print_header,
        print_info,
...
def _is_connected(config) -> bool:
    ...
    """
    import pm_copilot_engine._internal.hermes_cli.gateway as gateway_mod
