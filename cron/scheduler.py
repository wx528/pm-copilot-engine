...
from pm_copilot_engine._internal.hermes_cli._subprocess_compat import windows_hide_flags
from pm_copilot_engine._internal.hermes_cli.config import load_config, _expand_env_vars
from pm_copilot_engine.hermes_time import now as _hermes_now
...
def _resolve_cron_enabled_toolsets(job: dict, cfg: dict) -> list[str] | None:
    ...
    if per_job:
        return per_job
    try:
        from pm_copilot_engine._internal.hermes_cli.tools_config import _get_platform_tools  # lazy: avoid heavy import at cron module load
...
def _resolve_single_delivery_target(job: dict, deliver_value: str) -> Optional[dict]:
    ...
    if ":" in deliver_value:
        ...
        from pm_copilot_engine.tools.send_message_tool import _parse_target_ref
...
def _send_media_via_adapter(
    ...
    for media_path, _is_voice in media_files:
        try:
            ...
            from pm_copilot_engine.agent.async_utils import safe_schedule_threadsafe
...
def _deliver_result(job: dict, content: str, adapters=None, loop=None) -> Optional[str]:
    ...
    from pm_copilot_engine.tools.send_message_tool import _send_to_platform
...
def _build_job_prompt(job: dict, prerun_script: Optional[tuple] = None) -> str:
    ...
    from pm_copilot_engine.tools.skills_tool import skill_view
    from pm_copilot_engine.tools.skill_usage import bump_use
    from pm_copilot_engine.agent.skill_bundles import build_bundle_invocation_message, resolve_bundle_command_key
...
def _scan_assembled_cron_prompt(
    ...
    *,
    ...
    """
    from pm_copilot_engine.tools.cronjob_tools import _scan_cron_prompt, _scan_cron_skill_assembled
...
def run_job(job: dict) -> tuple[bool, str, str, Optional[str]]:
    ...
    try:
        ...
        try:
            from pm_copilot_engine.hermes_constants import apply_ipv4_preference
        ...
        from pm_copilot_engine.hermes_constants import parse_reasoning_effort
        ...
        from pm_copilot_engine._internal.hermes_cli.runtime_provider import (
...
"""
        ...
        try:
            from pm_copilot_engine.agent.auxiliary_client import cleanup_stale_async_clients
...
def tick(verbose: bool = True, adapters=None, loop=None, sync: bool = True) -> int:
    ...
    try:
        ...
        def _sweep_mcp_orphans() -> None:
            try:
                from pm_copilot_engine.tools.mcp_tool import _kill_orphaned_mcp_children
